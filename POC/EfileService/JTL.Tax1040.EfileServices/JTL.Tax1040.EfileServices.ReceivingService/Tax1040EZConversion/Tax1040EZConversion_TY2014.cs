    ...
    public class Tax1040EZConversion_TY2014
    {
        ...
        public IRSSchemaDE CreateTax1040EZchema(IRSSchemaDE objIRSSchemaDE)
        {
            if (objIRSSchemaDE != null)
            {
                ...
                JTL.Tax1040.BusinessObject.Tax1040 objTax1040BO = JsonConvert.DeserializeObject<JTL.Tax1040.BusinessObject.Tax1040>(objIRSSchemaDE.VendorXML);
                ...
                if (objTax1040BO != null)
                {
                    ...
                    long TodaysCountforSubmissionId = 2;   // Swapnesh  objTaxXMLtoIRSSchemaBL.GetTodayCount();
        ...
        private ReturnHeaderType CreateReturnHeader(JTL.Tax1040.BusinessObject.Tax1040 objTax1040BO, IRSSchemaDE objIRSSchemaDE)
        {
            ...
            if (objTax1040BO.OutputForms != null && objTax1040BO.OutputForms.Tax8879Page1 != null)
            {
                ...
                {
                    objReturnHeader.PrimarySignaturePIN = objTax1040BO.OutputForms.Tax8879Page1.TaxPayerPIN;
        ...
        private ReturnHeaderTypeSelfSelectPINGrp CreateSelfSelectPINGrp(JTL.Tax1040.BusinessObject.Tax1040 objTax1040BO)
        {
            ...
            if (objTax1040BO.PersonalDetails.PrimaryTaxPayer != null && objTax1040BO.PersonalDetails.PrimaryTaxPayer.Person != null)
            {
                ...
                if (objTax1040BO.IRSTransmission != null)
                {
                    if (objTax1040BO.IRSTransmission.HavePriorYearPIN) // IsPrimaryPriorYearPINSpecified)
                    {
                        returnHeaderTypeSelfSelectPIN.PrimaryPriorYearPIN = objTax1040BO.IRSTransmission.PrimaryPriorYearPIN;
                    }
                    ...
                    if (objTax1040BO.IRSTransmission.HavePriorYearAGI) //IsPrimaryPriorYearAGISpecified)
                    {
                        returnHeaderTypeSelfSelectPIN.PrimaryPriorYearAGIAmt = objTax1040BO.IRSTransmission.PrimaryPriorYearAGI.ToString();
                    }
            ...
            if (objTax1040BO.PersonalDetails.Spouse != null && objTax1040BO.PersonalDetails.Spouse.Person != null)
            {
                ...
                if (objTax1040BO.IRSTransmission != null)
                {
                    if (objTax1040BO.IRSTransmission.HavePriorYearPIN)//IsSpousePriorYearPINspecified)
                    {
                        returnHeaderTypeSelfSelectPIN.SpousePriorYearPIN = objTax1040BO.IRSTransmission.SpousePriorYearPIN;
                    }
        ...
        private IRS1040EZ CreateIRS1040EZ(JTL.Tax1040.BusinessObject.Tax1040 objTax1040BO)
        {
            ...
            if (objTax1040BO.Settlement != null && objTax1040BO.Settlement.IRS != null && objTax1040BO.Settlement.IRS.BankDetails != null)
            {
            ...
            foreach (JTL.Tax1040.BusinessObject.W2 formirsw2 in objTax1040BO.Income.W2Wages)
            {
                ...
                if (formirsw2.W2StateLocalTaxInfo != null)
                {
                    ...
                    foreach (W2StateLocalTaxInfo w2stateLocalTaxInfo in formirsw2.W2StateLocalTaxInfo)
                    {
                        ...
                        //** doubt
                        if (!string.IsNullOrEmpty(w2stateLocalTaxInfo.StateCode))
                        {
