...
namespace Tax1040Web
{
    public partial class F1040EZLineByLineCalculations : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            tax1040.Income.Form8862 = new List<Form8862>();
            ...
            {
                form8862.DaysLivedInUS = Convert.ToDouble(txtTaxpayer8862.Text);
            }

            if (!string.IsNullOrEmpty(txtspouse8862.Text))
            {
                form8862.DaysSpouseLivedInUS = Convert.ToDouble(txtspouse8862.Text);
            }
            tax1040.Income.Form8862.Add(form8862);
        ...
        private void Generate1040EZForm(dynamic output)
        {
            ...
            byte[] pdfData = bind.f1040EZPage1Binding(tax1040Object);

            //Added to check Worksheet Binding
            //var bind = new EICWorksheetPDFBinding();
            //byte[] pdfData = bind.EICWorksheetPage1Binding(tax1040Object);
