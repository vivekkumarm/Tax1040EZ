/*
    ...
    File Name       :   StandardDeductionWorksheetPDFBinding.cs 
    Description     :   StandardDeductionWorksheetPDFBinding PDFBinding Method.
    Author          :   Vincent 
...
{
    public class StandardDeductionWorkSheetPDFBinding
    {
        #region EICWorksheetPage1Binding
        public byte[] StandardDeductionWorksheetPage1Binding(BusinessObject.Tax1040 tax1040Object)
        {
            var pdfReader = new PdfReader(PDFTemplates.StandardDeductionWorkSheetOutputForm);
            using (var memoryStream = new MemoryStream())
            {
                ...
                XElement mappingXelements = XElement.Load(Assembly.GetExecutingAssembly().GetManifestResourceStream("JTL.Tax1040.PDFBinding.PdfXmlMappers.StandardDeductionWorkSheetPdfSchema.xml"));
                ...
                byte[] StandardDeductionWorksheetPage1 = memoryStream.GetBuffer();
                return StandardDeductionWorksheetPage1;
