...
namespace JTL.Tax1040.BusinessLogic.Test
{
    ...
    public class IT_IntrestIncomeForm1099OIDRepository
    {
        ...
        public void PersistForm1099OID()
        {
            ...
            var form1099OIDId = mInterestIncomeRepository.PersistTaxReturnForm1099OIDData(mUserId,taxReturnData);
        ...
        public void PersistMoreThanOneForm1099OID()
        {
            ...
            taxReturnData.TaxData = Newtonsoft.Json.JsonConvert.SerializeObject(CreateForm1099OID());
            taxReturnData.UserDataId = mUserDataId;
            long form1099OIDId1 = mInterestIncomeRepository.PersistTaxReturnForm1099OIDData(mUserId, taxReturnData);
            ...
            taxReturnData.TaxData = Newtonsoft.Json.JsonConvert.SerializeObject(CreateForm1099OID());
            taxReturnData.UserDataId = mUserDataId;
            long form1099OIDId2 = mInterestIncomeRepository.PersistTaxReturnForm1099OIDData(mUserId, taxReturnData);
        ...
        public void PersistForm1099OIDWitOutPayerAddress()
        {
            ...
            form1099OIDId = mInterestIncomeRepository.PersistTaxReturnForm1099OIDData(mUserId, taxReturnData);
            Assert.AreEqual(form1099OID.Form1099OIDId, form1099OIDId);
         ...
         public void UpdateNewStateInfo()
        {
            taxReturnData.TaxData = Newtonsoft.Json.JsonConvert.SerializeObject(CreateForm1099OID());
            taxReturnData.UserDataId = mUserDataId;
            var expectedform1099OIDId = mInterestIncomeRepository.PersistTaxReturnForm1099OIDData(mUserId, taxReturnData);
            ...
            var actualform1099OIDId = mInterestIncomeRepository.PersistTaxReturnForm1099OIDData(mUserId, taxReturnData);
