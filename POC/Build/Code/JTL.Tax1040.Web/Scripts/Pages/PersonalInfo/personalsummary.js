        ...
        success: function (data, textStatus) {
            ...
            if (data.m_Item2 != null && data.m_Item2.length > 0) {
                ...
                $.each(data.m_Item2, function (index, value) {
                    ...
                    if ((value.Tab == Tab.PersonalInfo) && (value.MessageType == MessageType.ER)) {   // 20Jun2014 Sathish replaced hard coded value with the constant
                ...
                if (hasPersonalInfoEligibilityDiagnostics) {
                    ...
                    window.location.href = '../Diagnostics/finaldiagnostics.html?Tab=' + Tab.PersonalInfo + '&FilingStatus=' + filingStatus; 
                    return false;
                }
            }
            if (data.m_Item2 == null||data.m_Item2.length == 0) {
