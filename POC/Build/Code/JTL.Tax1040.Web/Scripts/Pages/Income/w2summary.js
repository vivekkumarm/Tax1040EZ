...
$(document).ready(function () {
    ...
    $('#btnContinue').click(function () {
        ...
        if (hasIncomeEligibilityDiagnostics) {
            pageToNavigate = '../Diagnostics/finaldiagnostics.html?Topic=' + Topic.Wages;   // 20Jun2014 Sathish replaced hard coded value with the constant
        }
        else {
                    ...
                    if (value.W2Id != 0) {
                        ...
                        $("#w2summaryinfo").append('<div class="pangird itm"><label class="col-md-4">'
                            + employerName + '</label>' +
                                           ...
                                           '<label class="col-md-3">' + totalWagesAmount.toFixed(2) + '</label>' +
