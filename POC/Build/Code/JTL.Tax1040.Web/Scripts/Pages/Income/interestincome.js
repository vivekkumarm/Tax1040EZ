    ...
    if ($("#frmInterestIncome").valid()) {
        ...
        if (f1099INT != null) {
            F1099INTPersistData = {
                ...
                TaxExemptInterestStateId: f1099INT.TaxExemptInterestStateId,
...
function setPopup() {
    $(function () {
        $("#popPayerName").popover({ title: '', content: "<h5>PayerName</h5><br />Full Name of the tax payer.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#popPayerEIN").popover({ title: '', content: "<h5>Payer's Federal Identification Number</h5><br /> Unique 9 digit identification number assigned by IRS for an individual for identification purposes. You can find the digits of EIN in the format as XX-XXXXXXX.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
}
