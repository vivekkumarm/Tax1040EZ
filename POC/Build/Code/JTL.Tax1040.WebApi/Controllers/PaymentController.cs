...
namespace JTL.Tax1040.WebApi.Controllers
{
    public class PaymentController : ApiController
    {
        ...
        {
            return paymentRepository.GetProductSKUbyStateIDs(paymentDTO);
        }
       ...
       [HttpPost]
        public System.Tuple<long, List<ErrorMessage>> PersitIRSPaymentOption(PaymentDTO paymentDTO)
        {
            return paymentRepository.PersitIRSPaymentOption(paymentDTO);
        }
