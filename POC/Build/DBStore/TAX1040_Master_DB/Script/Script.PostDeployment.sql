...
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES(	'EarnedIncomeCredit_BR3','EIC -  Invalid SSN','EIC -  Invalid SSN','Credit','EarnedIncomeCredit','Information','BR','You & Your Spouse (if MFJ) should not have a Valid Social security Number','You & Your Spouse should not have a Valid Social security Number.','','')
...
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES(	'EarnedIncomeCredit_BR5','EIC - Lived in United States more than half of the year','Lived in United States more than half of the year','Credit','EarnedIncomeCredit','Information','BR','You did not stayed in united States for more than half of the year.','You did not stayed in united States for more than half of the year.','','')
...
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES(	'EarnedIncomeCredit_BR7','EIC - Received notice from IRS for not to claim EIC Credit','Received notice from IRS for not to claim EIC Credit','Credit','EarnedIncomeCredit','Information','BR',' You are prohibited by IRS that  You are not eligible to claim EIC Credit',' You are prohibited by IRS that  You are not eligible to claim EIC Credit','','')
...
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_BR9','Earned Income Credit was reduced or disallowed due to Math or clerical Error','EarnedIncomeCredit was reduced or disallowed due to Math or clerical Error','Credit','EarnedIncomeCredit','Warning','BR',' The Form 8862 is used to report EarnedIncomeCredit was reduced or disallowed for any reason other than a math or clerical error for a year after 1996  and to claim EIC for the year.','Earned Income Credit was reduced or disallowed for any reason other than a math or clerical error','','')
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_BR10','EIC was reduced or disallowed in the earlier year','EIC was reduced or disallowed in the earlier year was because of Incorrectly reported the  Earned  or Investment Income.','Credit','EarnedIncomeCredit','Warning','BR','The only reason Your EIC was reduced or disallowed in an earlier year was because You incorrectly reported Your Earned Income or Investment Income, You do not complete the rest of this form. You must attach this Form 8862 to Your tax return to take the EIC.',' EIC was reduced or disallowed in an earlier year was because You incorrectly reported Your Earned Income or Investment Income','','')
