...
$(document).ready(function () {
    ...
    $('#btnContinue').click(function () {
        ...
        if (hasIncomeEligibilityDiagnostics) {
            ...
            pageToNavigate = '../Review/finalsummary.html?Topic=' + Topic.UnemploymentCompensation;  // 20Jun2014 Sathish replaced hard coded value with the constant
        }
        else {
                    ...
                    $.each(data.m_Item1, function (index, value) {
                        ...
                        if (value.Form1099GId != 0) { //Saravanan N - It is not necessary to show this record.
                            ...
                            $("#dvUnemploymentSummary").append('<div class="pangird itm">' +
                                ...
                                '<label class="col-md-3">' + currencyformate(totalUnempCompensation.toFixed(2)) + '</label>' +
                                '<label class="col-md-2"><a href="' + editRedirectLink + '" title="Edit" class="i-edit"></a><a href="#" title="Delete" onclick="DeleteUnEmployment(' + value.Form1099GId + ');return false;" class="i-delete"></a></label></div>');
                   ...
                   // var errorKnt = 0;
                    if (data.m_Item2.length > 0) {
                        ...
                        $.each(data.m_Item2, function (index, value) {
                            if (value != null) {
                                if ((value.Topic == Topic.unempCompensation) && (value.MessageType == MessageType.ER)) {
