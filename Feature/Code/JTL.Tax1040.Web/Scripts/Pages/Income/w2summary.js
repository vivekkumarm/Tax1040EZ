    ...
    $('#btnContinue').click(function () {
        ...
        if (hasIncomeEligibilityDiagnostics) {
            ...
            if (isInterestIncomeHasValue) {
                //Saravanan N - 5th Aug, 2014 - As discussed with Praveen whether Int. Income summary / check list page load logic moved to InterestIncomeSummary page load.
...
function GetW2SummaryData() {
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            ...
            // Swapnesh   $("#divDiagnosticsParent").hide();//Saravanan N - 14th May, 2014 - Default hide the diagnostics.
        },
        success: function (data, textStatus) {
                                ...
                                + employerName + '</label>' +
                                               ...
                                               '<label class="col-md-3">' + currencyformate(totalWagesAmount.toFixed(2)) + '</label>' +
                                                    '<label class="col-md-2">' +
                                                         ...
                                                         + '" title="Edit" class="i-edit"></a>' +
                                                         '<a href="#" title="Delete" onclick="DeleteW2('
                                                         + value.W2Id + ');return false;"  class="i-delete"></a>' +
                                               '</label></div>');
                        }
                    }
            ...
            //   $("#dvDiagnostics").empty();
            // Swapnesh    $("#divDiagnosticsParent").hide();//Saravanan N - 13th May, 2014 - Default hide the diagnostics.
