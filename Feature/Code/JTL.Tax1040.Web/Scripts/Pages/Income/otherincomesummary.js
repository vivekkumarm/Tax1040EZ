        ...
        success: function (data, textStatus) {
            ...
            if (data != null) {
                ...
                if (data.m_Item1 != null) {
                    ...
                    //Yogalakshmi - 11th August 2014 - Defect Fix for TAX1040-14448 
                    if (!data.m_Item1.HasSsbAndRrb && !data.m_Item1.HasAlaskaPermanantFund && !data.m_Item1.HasStateTaxRefund) {
                    ...
                    if (data.m_Item1.HasSsbAndRrb) {
                        ...
                        //Yogalakshmi - 12th August 2014 - Defect fix for TAX1040-14430 - If SSB and RRb is null hten it should display the Taxpayer Name.
                        ...
                        //Yogalakshmi - 25th August 2014 - Defect fix for TAX1040-14507 Scenario 2
                        if ((taxPayerSSBNetBenefits != null && taxPayerSSBNetBenefits >= 0) &&
                            (spouseRRBNetBenefits != null && spouseRRBNetBenefits >= 0)) {
                            benefitsRecipientsName = taxPayerFirstName + " " + spouseFirstName;
                        }
                                                ...
                                                + SSA_RRB + '</label>' +
                                                               ...
                                                               '<label class="col-md-3">' + currencyformate(totalbenefitIncomeAmount.toFixed(2)) + '</label>' +
                                                                    '<label class="col-md-2">' +
                                                                         '<a href="../../../Income/otherincome.html" title="Edit" class="i-edit"></a>' +
                                                                         '<a href="#" onclick="DeleteOtherIncomeByOtherIncomeType(' + SSA_AND_RRB + ');return false;" title="Delete" class="i-delete"></a>' +
                                                               '</label></div>';
                    }
                    ...
                    if (data.m_Item1.HasAlaskaPermanantFund) {
                        ...
                        recordsFound = true;
                        //Yogalakshmi - 12th August 2014 - Defect fix for TAX1040-14430 - If Alaska amount is null hten it should display the Taxpayer Name.
                        ...
                        dvSummary = ((typeof dvSummary == "undefined") ? "" : dvSummary) + '<div class="pangird itm"><label class="col-md-4">'
                                                   + ALASKA_FUND + '</label>' +
                                                                  ...
                                                                  '<label class="col-md-3">' + currencyformate(totalalsakaIncomeAmount.toFixed(2)) + '</label>' +
                                                                       '<label class="col-md-2">' +
                                                                            '<a href="../../../Income/otherincome.html' + "?collapseTwo" + '" title="Edit" class="i-edit"></a>' +
                                                                            '<a href="#" onclick="DeleteOtherIncomeByOtherIncomeType(' + ALASKA_DIVIDEND_FUND + ');return false;" title="Delete" class="i-delete"></a>' +
                                                                  '</label></div>';
                        ...
                        dvSummary = ((typeof dvSummary == "undefined") ? "" : dvSummary) + '<div class="pangird itm"><label class="col-md-4">'
                                                 + State_Tax + '</label>' +
                                                                ...
                                                                '<label class="col-md-3">' + "" + '</label>' +
                                                                     '<label class="col-md-2">' +
                                                                          '<a href="../../../Income/otherincome.html' + "?collapseThree" + '" title="Edit" class="i-edit"></a>' +
                                                                          '<a href="#" onclick="DeleteOtherIncomeByOtherIncomeType(' + State_Tax_Refund + ');return false;" title="Delete" class="i-delete"></a>' +
                                                                '</label></div>';
                    }
...
function DeleteOtherIncomeByOtherIncomeType(otherIncomeType) {
    if (confirm("Are you sure that you want to delete the selected Form?")) {
        $.ajax({
