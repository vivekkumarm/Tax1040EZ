...
var showInterestIncomeChecklist;
...
$(document).ready(function () {
    ...
    //Saravanan N - 5th Aug, 2014 - As discussed with Praveen whether Int. Income summary / check list page load logic handled in Int. Income Summary page load.
    if (showInterestIncomeChecklist) {
        window.location.href = '../Income/interestincomechecklist.html';
    }
    ...
    $.ajax({
        ...
        success: function (data, textStatus) {
            if (data != null) {
                        ...
                        $.each(data.m_Item1.Form1099INT, function (index, value) {
                            ...
                            if (value.Form1099INTId != 0) {
                                ...
                                $("#dvInterestIncomeSummary").append('<div class="pangird itm"><label class="col-md-4">' + payerName + '</label>' +
                                                                    ...
                                                                    '<a class="i-edit" href="../Income/interestincome.html?Form1099INTId=' +
                                                                    value.Form1099INTId + '" title="Edit" "></a>' +
                                                                    '<a href="#" title="Delete" onclick="DeleteINT(' +
                                                                    value.Form1099INTId + ');return false;" class="i-delete"></a>' +
                                                                    '</label></div>');
                        ...
                        $.each(data.m_Item1.Form1099OID, function (index, value) {
                            ...
                            if (value.Form1099OIDId != 0) {
                                ...
                                $("#dvInterestIncomeSummary").append('<div class="pangird itm"><label class="col-md-4">' + payerName + '</label>' +
                                                                 ...
                                                                 '<label class="col-md-2">' +
                                                                     '<a class="i-edit" href="../Income/interestincome.html?Form1099OIDId=' +
                                                                     value.Form1099OIDId + '" title="Edit" "></a>' +
                                                                     '<a href="#" title="Delete" onclick="DeleteOID(' + value.Form1099OIDId +
                                                                     ');return false;" class="i-delete"></a>' +
                                                                 '</label></div>');
                ...
                //Saravanan N - 30th July, 2014 - Blank space removed after $.
    ...
    $.ajax({
        ...
        success: function (data, textStatus) {
            if (data != null) {
                ...
                showInterestIncomeChecklist = data.showInterestIncomeChecklist;
            }
        }
    });
}