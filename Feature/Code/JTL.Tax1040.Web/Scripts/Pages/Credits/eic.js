...
$(document).ready(function () {
    ...
    $('#radInmateWagesYes').removeClass("form-control tip amountField").addClass("form-radio");
    $('#radInmateWagesNo').removeClass("form-control tip amountField").addClass("form-radio");
    $('#radEICforPriorYearDisallowanceYes').removeClass("form-control tip amountField").addClass("form-radio");
    $('#radEICforPriorYearDisallowanceNo').removeClass("form-control tip amountField").addClass("form-radio");
    $('#radIncorrectlyReportedEarnedIncomeYes').removeClass("form-control tip amountField").addClass("form-radio");
    $('#radIncorrectlyReportedEarnedIncomeNo').removeClass("form-control tip amountField").addClass("form-radio");
            ...
            if (!isEicEligible) {
                ...
                if (data.m_Item1 != null) {
                    ...
                    if (data.m_Item1.HasPenalInstitutionInmateWages && data.m_Item1.HasPenalInstitutionInmateWages != null) {
                        ...
                        $('#divInmateWages').show();
                        $("#txtInmateWages").val(data.m_Item1.PenalInstitutionInmateWages == null ? "" : data.m_Item1.PenalInstitutionInmateWages.toFixed(2));
                    }
