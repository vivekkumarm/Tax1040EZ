                ...
                if (data.m_Item1 != null) {
                    ...
                    $.each(data.m_Item1, function (index, value) {
                        ...
                        //    $("#dvDiagnostics").append('<a href="' + navigateURL + '">' + value.ErrorText + '</a>');
                            $("#dvDiagnostics").append('<div class="msgerrors"> <a href="' + navigateURL + '"> ' + value.ErrorText + '.</a><span>' + value.Topic + '</span></div>');
                            ...
                            $("#dvDiagonsticWarning").append('<div class="msgerrors"> <a href="' + navigateURL + '"> ' + value.ErrorText + '.</a><span>' + value.Topic + '</span></div>');
                            ...
                            $("#dvDiagonsticInformation").append('<div class="msgerrors"> <a href="' + navigateURL + '"> ' + value.ErrorText + '.</a><span>' + value.Topic + '</span></div>');
