...
$(document).ready(function () {
    ...
    //21 Aug 2014-Vincent- Fixed the bug Code :TAX1040-14522
...
$(function () {
    ...
    $("#popEmail").popover({ title: 'Quick Help', html: 'true', content: "<h5>Which Email Address do we need?</h5>Share us the Email Address that you used while creating the account.<br/><br/>We will use it to mail you the account reset information.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
});
});

//Vivek, 5Aug14, method removed to fix the onBlur issue
