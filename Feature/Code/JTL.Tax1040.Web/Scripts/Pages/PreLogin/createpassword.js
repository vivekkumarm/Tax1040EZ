...
$(document).ready(function () {
    ...
    $("#NewPassword").validate({
        ...
        messages: {
            txtUserName: "Username is missing.",
            txtNewPassword: {
    ...
    $(function () {
        $("#popUserName").popover({ title: 'Quick Help', html: 'true', content: "<h5>Where to find your Username?</h5>We have mailed your TaxGarden Username to the Email Address associated with your account. It's a part of our stringent security measures.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popNewPassword").popover({ title: 'Quick Help', html: 'true', content: "<h5>How to set a New Password?</h5>The Password you enter here will be your New Tax Garden Password..<br/><br/> Make sure to throw in at least one alphabet, one number, and one special character. Use at least 8 characters and try keeping it hard for the hackers.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popConfirmPassword").popover({ title: 'Quick Help', html: 'true', content: "<h5>Why should you retype the Password?</h5>How would you check if what you had typed has no typo errors?<br/><br/>Simple! Retype it here and see for yourself.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
    ...
    if ($("#NewPassword").valid()) {
        $.ajax({
            ...
            success: function (data, textStatus) {
                if (data.m_Item1 == false) {
                    $("#divErrorMsg").show();
                    $("#divErrorMsg").text(data.m_Item2);
                }
                else {
