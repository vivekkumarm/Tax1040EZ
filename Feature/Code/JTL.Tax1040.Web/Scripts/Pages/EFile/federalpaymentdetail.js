...
$(document).ready(function () {
    ...
    // 01Aug2014 Sathish added validation for the defect #TAX1040-14254
    // 18Aug2014 Sathish changed account number to accept letter number and hypen based on spec 1.5
    NumbersLettersAndHyphen('txtAccountNumber'); 
        ...
        success: function (data, textStatus) {
            if (data != null) {
                if (data.m_Item1 != null && data.m_Item1 > 0) {
                    ...
                    //20Aug2014 Sathish commented since navigation is set in filing option summary and left menu
