...
function PersistFiling() {
    ...
    $.each($('#divFilerState').children('div'), function (key, value) {
        selectedStateFile = {
            ...
            //20Aug2014 Sathish Cleared IRS Transmision detail while changing the filing option
            StateTransmission: ((filing != null &&
                                 filing.StateFiling != null &&
                                 filing.StateFiling[key] != null &&
                                 filing.StateFiling[key].IsEfile == ($("#radStateEFiling" + key).prop('checked') ? true
                                                                     : ($("#radStatePaperFiling" + key).prop('checked') ? false : null))) ?
    ...
    filing = {
        ...
        FederalFiling: {
            ...
            //20Aug2014 Sathish Cleared IRS Transmision detail while changing the filing option
            IRS: ((filing != null && filing.FederalFiling != null &&
                filing.FederalFiling.IsEfile == ($("#radFederalEFiling").prop('checked') ? true : ($("#radFederalPaperFiling").prop('checked') ? false : null)) &&
                filing.FederalFiling.IRS != null) ? filing.FederalFiling.IRS : null)
        },
