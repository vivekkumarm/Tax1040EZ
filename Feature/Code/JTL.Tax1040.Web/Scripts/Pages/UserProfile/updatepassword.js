...
$(document).ready(function () {
    ...
    $("#updatepassword").validate({
        ...
        messages: {
            ...
            txtNewPassword: {
                ...
                maxlength: "Invalid Password",
                passwordvalidation: "Invalid Password",
                notequalto: "Your Old Password and New Password should not be same"
            },
            txtConirmPassword: {
                required: "Missing Confirm Password",
                equalTo: "Confirm Password and Password does not match",
                notequalto: "Your Old Password and Confirm Password should not be same"
            }
        }
    });
    ...
    $(function () {
        $("#popOldPassword").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is your  Old Password?</h5>Enter the Password that you used  earlier to secure your Tax Garden account. <br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popNewPassword").popover({ title: 'Quick Help', html: 'true', content: "<h5>How to choose a New Password?</h5>This will be your new secret combination to secure your Tax Garden account.<br/><br/>Throw in a minimal of 8 characters, that surely includes at least one alphabet, one number, and one special character. <br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popConirmPassword").popover({ title: 'Quick Help', html: 'true', content: "<h5>Why should you retype the New Password?</h5>Let's be sure of what you planned to use as your New Password is what actually you typed.<br/><br/>Retype your New Password to confirm it. <br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
