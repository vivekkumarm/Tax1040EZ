...
$(document).ready(function () {
    ...
    $(function () {
        $("#popEmailId").popover({ title: 'Quick Help', html: 'true', content: "<h5>Why do we need a New Email ID?</h5>We need your new Email ID to communicate to you without any interruption.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
