...
$(document).ready(function () {
    ...
    $(function () {
        $("#popSecurityQuestion").popover({ title: 'Quick Help', html: 'true', content: "<h5>Wanna update your security question?</h5>Choose a question you wish to answer from this list to make it happen.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popSecurityAnswer").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is 'Security Answer'?</h5>This is nothing but, the secret answer you gave for the Security Question you selected.  <br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popPassword").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is your Password? </h5>This is a secret string of characters you chose to secure your Tax Garden account.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
});
