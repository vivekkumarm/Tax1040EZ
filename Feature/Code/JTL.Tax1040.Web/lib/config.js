...
function LettersAndSpaceOnly(cntrl, e) {
    ...
    $('#' + cntrl).blur(function (e) {
        ...
        if (currentObjectName != '' && currentObjectName != this.id) return;

        currentObjectName = this.id;
            ...
            if (decimalPlaces != 0) {
                ...
                if (reg3Array != null) {
                    ...
                    if (temp == '') {
                        ...
                        if (obj.maxLength == temp.length) {
                            temp = temp.substring(0, obj.maxLength - (decimalPlaces + 1)) + '.' + temp.substring((obj.maxLength - (decimalPlaces + 1)), obj.maxLength - 1);
                        }
                        else
                            if (obj.maxLength - 1 == temp.length - 1) {
                                temp = temp.substring(0, obj.maxLength - (decimalPlaces + 1)) + '.' + temp.substring((obj.maxLength - (decimalPlaces + 1)), obj.maxLength - 1);
                            }
                            else {
                                temp = temp + '.00';
...
//Masked the input phone number to display in "123-223-1234" format
function maskInput(input, textbox, location, eventoftxtbox, checkforZipCode, Phonenumber) {
    ...
    if (eventoftxtbox.keyCode != 37 && eventoftxtbox.keyCode != 38 && eventoftxtbox.keyCode != 39 && eventoftxtbox.keyCode != 40 && eventoftxtbox.keyCode != 17) {
        ...
        if (currentindex != 'undefined') {
            ...
            if (eventoftxtbox.keyCode == 46 || eventoftxtbox.keyCode == 8) {
