...
document.write("<div id='incomeleftmenu' class='menu btn-breadcrumb' role='navigation'>" +
    "<div id='lftmenu'>" +
    "<ul id='nav' class='nav side-nav'>" +
    "<li id='aW2Summary'> <a href='../Income/w2summary.html'><i class='fa fa-exchange'></i>Wages<sup id='supw2ErrorCount' class='badge tip' data-toggle='tooltip' data-placement='top'></sup></a></li>" +
    "<li id='aInterestIncomeSummary'> <a href='../Income/interestincomesummary.html'><i class='fa fa-user'></i>Interest Income <sup id='supInterestIncomeErrorCount' class='badge tip' data-toggle='tooltip' data-placement='top'></sup></a></li>" +
    "<li id='aunemploymentSummary'><a href='../Income/unemploymentsummary.html'><i class='fa fa-users'></i>Unemployment <sup id='supUnemploymentErrorCount' class='badge tip' data-toggle='tooltip' data-placement='top'></sup></a></li>" +
    "<li id='aOtherIncomeSummary'><a href='../Income/otherincomesummary.html'><i class='fa fa-suitcase'></i>Other Income <sup id='supOtherIncomeErrorCount' class='badge tip' data-toggle='tooltip' data-placement='top'></sup></a></li>" +
        ...
        $.ajax({
            ...
            success: function (data, textStatus) {
                if (data != null) {
                    ...
                    if (data.m_Item5.m_Item1 > 0) {
                        $('#supw2ErrorCount').html(data.m_Item5.m_Item1);
                    }
                    if (data.m_Item5.m_Item2 > 0) {
                        $('#supInterestIncomeErrorCount').html(data.m_Item5.m_Item2);
                    }
                    if (data.m_Item5.m_Item3 > 0) {
                        $('#supOtherIncomeErrorCount').html(data.m_Item5.m_Item3);
                    }
                    if (data.m_Item5.m_Item4 > 0) {
                        $('#supUnemploymentErrorCount').html(data.m_Item5.m_Item4);
                    }
                }
