...
var isFederalEfile;
var hasError = false;
var taxOwnAmount = 0; //20aug2014 Sathish taxOwnAmount used for redirection
document.write("<div id='reviewleftmenu' class='menu' role='navigation'>" +
    ...
    "<li id='liFederal'><a id='lnkFederal' href='#'><i class='fa fa-user'></i>Federal</a></li>" +
