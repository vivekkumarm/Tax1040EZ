...
namespace JTL.Tax1040.BusinessLogic.Test
{
    ...
    public class IT_InterestIncomeForm1099INTRepository
    {
        ...
        public void TestInitialize()
        {
            ...
            HttpRuntime.Cache["ErrorMessageCollection"] = messageRepository.GetErrorMessages();
        ...
        [TestMethod]
        [TestCategory("109INT")]
        public void ValidateInterestIncomeBR1()
        {
            //Error Free Scenario
            //Persist personal data
            var givenPrimaryTaxPayer = IT_PersonalInfo.CreatePrimaryTaxPayer(FilingStatus.Single);
            ...
            var expectedForm1099INT = CreateForm1099INT(OwnerType.PrimaryTaxPayer);
            expectedForm1099INT.InterestIncome = 800;
            expectedForm1099INT.FederalTaxWithHoldingAmount = 1000;
            expectedForm1099INT.InterestIncome = 500;
            expectedForm1099INT.USBondsTreasury = 500;
            ...
            //Persist first Form 1099INT with InterestIncome value.
            var actualFormINTData = mInterestIncomeRepository.PersistTaxReturnForm1099INTData(mUserData);

            string taxObject = mTaxReturnRepository.GetTaxReturnDatabyUserDataId(actualFormINTData.UserDataId, mUserId);
            var actualTax1040 = JsonConvert.DeserializeObject<BusinessObject.Tax1040>(taxObject);

            Assert.IsFalse(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR1")));

            //Error Scenario
            expectedForm1099INT.FederalTaxWithHoldingAmount = 1001;
            ...
            //Persist first Form 1099INT with InterestIncome value.
            actualFormINTData = mInterestIncomeRepository.PersistTaxReturnForm1099INTData(mUserData);

            taxObject = mTaxReturnRepository.GetTaxReturnDatabyUserDataId(actualFormINTData.UserDataId, mUserId);
            actualTax1040 = JsonConvert.DeserializeObject<BusinessObject.Tax1040>(taxObject);

            Assert.IsTrue(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR1")));
        ...
        [TestMethod]
        [TestCategory("109INT")]
        public void ValidateInterestIncomeBR2()
        {
            //Error Free Scenario
            //Persist personal data
            var givenPrimaryTaxPayer = IT_PersonalInfo.CreatePrimaryTaxPayer(FilingStatus.Single);
            ...
            expectedForm1099INT.InterestIncome = 500;
            expectedForm1099INT.USBondsTreasury = 500;
            expectedForm1099INT.InvestmentExpenses = null;
            ...
            Assert.IsFalse(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR2")));

            //Error Scenario
            expectedForm1099INT.InvestmentExpenses = 1;
            mTaxReturnData.UserDataId = userDataID.Item1;
            mTaxReturnData.TaxData = JsonConvert.SerializeObject(expectedForm1099INT);
            mUserData.userId = mUserId;
            mUserData.TaxReturnData = JsonConvert.SerializeObject(mTaxReturnData);
            ...
            Assert.IsTrue(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR2")));
        ...
        [TestMethod]
        [TestCategory("109INT")]
        public void ValidateInterestIncomeBR3()
        {
            //Error Free Scenario
            //Persist personal data
            var givenPrimaryTaxPayer = IT_PersonalInfo.CreatePrimaryTaxPayer(FilingStatus.Single);
            ...
            Form1099StateInformation form1099StateInformation1 = new Form1099StateInformation{
                StateIdentificationNumber  = "1",
                StateTaxWithholdingAmount = 500
            };

            Form1099StateInformation form1099StateInformation2 = new Form1099StateInformation{
                StateIdentificationNumber  = "1",
                StateTaxWithholdingAmount = 500
            };
            
            List<Form1099StateInformation> lstForm1099StateInformation  = new List<Form1099StateInformation>();
            lstForm1099StateInformation.Add(form1099StateInformation1);
            lstForm1099StateInformation.Add(form1099StateInformation2);

            expectedForm1099INT.Form1099StateInfo = lstForm1099StateInformation;
            ...
            Assert.IsFalse(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR3")));

            //Error Scenario
            expectedForm1099INT.InterestIncome = 499;
            ...
            Assert.IsTrue(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR3")));
        ...
        [TestMethod]
        [TestCategory("109OID")]
        public void ValidateInterestIncomeBR4()
        {
            //Error-Free Scenario 
            var givenPrimaryTaxPayer = IT_PersonalInfo.CreatePrimaryTaxPayer(FilingStatus.Single);
            var userDataID = mPersonalInfoRepository.PersistPrimaryTaxPayer(givenPrimaryTaxPayer, mUserId, mUserDataId);
            ...
            //Persist first Form 1099OID
            expectedForm1099OID.FederalTaxWithHoldingAmount = 600;
            expectedForm1099OID.OriginalIssueDiscount = 200;
            expectedForm1099OID.OtherPeriodicInterest = 200;
            expectedForm1099OID.USTreasuryObligations = 200;
            ...
            Assert.IsFalse(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR6")));

            //Error Scenario
            expectedForm1099OID.FederalTaxWithHoldingAmount = 601;
            mTaxReturnData.UserDataId = userDataID.Item1;
            mTaxReturnData.TaxData = JsonConvert.SerializeObject(expectedForm1099OID);
            mUserData.userId = mUserId;
            mUserData.TaxReturnData = JsonConvert.SerializeObject(mTaxReturnData);

            actualForm1099OIDData = mInterestIncomeRepository.PersistTaxReturnForm1099OIDData(mUserData);

            taxObject = mTaxReturnRepository.GetTaxReturnDatabyUserDataId(actualForm1099OIDData.UserDataId, mUserId);
            actualTax1040 = JsonConvert.DeserializeObject<BusinessObject.Tax1040>(taxObject);

            Assert.IsTrue(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR6")));
        ...
        [TestMethod]
        [TestCategory("109OID")]
        public void ValidateInterestIncomeBR5()
        {
            //Error-Free Scenario 
            var givenPrimaryTaxPayer = IT_PersonalInfo.CreatePrimaryTaxPayer(FilingStatus.Single);
            var userDataID = mPersonalInfoRepository.PersistPrimaryTaxPayer(givenPrimaryTaxPayer, mUserId, mUserDataId);
            ...
            var expectedForm1099OID = CreateForm1099OID(OwnerType.PrimaryTaxPayer);
            //Persist first Form 1099OID
            expectedForm1099OID.InvestmentExpenses = null;
            mTaxReturnData.TaxData = JsonConvert.SerializeObject(expectedForm1099OID);
            mTaxReturnData.UserDataId = userDataID.Item1;
            mUserData.userId = mUserId;
            mUserData.TaxReturnData = JsonConvert.SerializeObject(mTaxReturnData);
            ...
            Assert.IsFalse(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR7")));

            //Error Scenario
            expectedForm1099OID.InvestmentExpenses = 1;
            mTaxReturnData.UserDataId = userDataID.Item1;
            mTaxReturnData.TaxData = JsonConvert.SerializeObject(expectedForm1099OID);
            mUserData.userId = mUserId;
            mUserData.TaxReturnData = JsonConvert.SerializeObject(mTaxReturnData);
            ...
            Assert.IsTrue(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR7")));
        ...
        [TestMethod]
        [TestCategory("109OID")]
        public void ValidateInterestIncomeBR6()
        {
            //Error-Free Scenario 
            var givenPrimaryTaxPayer = IT_PersonalInfo.CreatePrimaryTaxPayer(FilingStatus.Single);
            var userDataID = mPersonalInfoRepository.PersistPrimaryTaxPayer(givenPrimaryTaxPayer, mUserId, mUserDataId);
            ...
            lstForm1099StateInformation.Add(form1099StateInformation1);
            lstForm1099StateInformation.Add(form1099StateInformation2);
            expectedForm1099OID.Form1099StateInfo = lstForm1099StateInformation;
            ...
            Assert.IsFalse(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR8")));

            //Error Scenario
            expectedForm1099OID.USTreasuryObligations = 199;
            ...
            Assert.IsTrue(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR8")));
        }
        ...
        [TestMethod]
        [TestCategory("109INT")]
        public void ValidateInterestIncomeBR7()
        {
            //Error Free Scenario
            //Persist personal data
            var givenPrimaryTaxPayer = IT_PersonalInfo.CreatePrimaryTaxPayer(FilingStatus.Single);
            var userDataID = mPersonalInfoRepository.PersistPrimaryTaxPayer(givenPrimaryTaxPayer, mUserId, mUserDataId);
            var expectedForm1099INT = CreateForm1099INT(OwnerType.PrimaryTaxPayer);
            expectedForm1099INT.ForeignTaxPaid = null;
            ...
            Assert.IsFalse(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR4")));

            //Error Scenario
            expectedForm1099INT.ForeignTaxPaid = 1;
            ...
            Assert.IsTrue(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR4")));
        }
        ...
        [TestMethod]
        [TestCategory("109OID")]
        public void ValidateInterestIncomeBR8()
        {
            //Error-Free Scenario 
            var givenPrimaryTaxPayer = IT_PersonalInfo.CreatePrimaryTaxPayer(FilingStatus.Single);
            var userDataID = mPersonalInfoRepository.PersistPrimaryTaxPayer(givenPrimaryTaxPayer, mUserId, mUserDataId);
            //Error Free Scenario
            var expectedForm1099OID = CreateForm1099OID(OwnerType.PrimaryTaxPayer);
            expectedForm1099OID.ForeignTaxPaid = null;
            ...
            Assert.IsFalse(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR9")));

            //Error Scenario
            expectedForm1099OID.ForeignTaxPaid = 1;
            ...
            Assert.IsTrue(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR9")));
        }
        ...
        [TestMethod]
        [TestCategory("109INT")]
        public void ValidateInterestIncomeBR9()
        {
            //Error Free Scenario
            //Persist personal data
            var givenPrimaryTaxPayer = IT_PersonalInfo.CreatePrimaryTaxPayer(FilingStatus.Single);
            var userDataID = mPersonalInfoRepository.PersistPrimaryTaxPayer(givenPrimaryTaxPayer, mUserId, mUserDataId);
            var expectedForm1099INT = CreateForm1099INT(OwnerType.PrimaryTaxPayer);
            expectedForm1099INT.EarlyWithdrawalPenalty = null;
            ...
            Assert.IsFalse(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR5")));

            //Error Scenario
            expectedForm1099INT.EarlyWithdrawalPenalty = 1;
            ...
            Assert.IsTrue(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR5")));
        }


        /// <summary>
        /// Business Rule #10 - OID
        /// </summary>
        [TestMethod]
        [TestCategory("109OID")]
        public void ValidateInterestIncomeBR10()
        {
            //Error-Free Scenario 
            var givenPrimaryTaxPayer = IT_PersonalInfo.CreatePrimaryTaxPayer(FilingStatus.Single);
            var userDataID = mPersonalInfoRepository.PersistPrimaryTaxPayer(givenPrimaryTaxPayer, mUserId, mUserDataId);
            //Error Free Scenario
            var expectedForm1099OID = CreateForm1099OID(OwnerType.PrimaryTaxPayer);
            expectedForm1099OID.EarlyWithdrawalPenalty = null;
            ...
            Assert.IsFalse(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR10")));

            //Error Scenario
            expectedForm1099OID.EarlyWithdrawalPenalty = 1;
            ...
            Assert.IsTrue(actualTax1040.ErrorMessages.Any(er => er.ErrorCode.Equals("InterestIncome_BR10")));
        }
        #endregion
