...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1040EZNonTaxableCombatPay : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _TotalNonTaxableCombatPayElection;
...
partial void AfterInitializeComponent();
        ...
        public F1040EZNonTaxableCombatPay() {
        ...
        public System.Activities.OutArgument<double> TotalNonTaxableCombatPayElection {
            get {
                return this._TotalNonTaxableCombatPayElection;
            }
            set {
                this._TotalNonTaxableCombatPayElection = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZNonTaxableCombatPay).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZNonTaxableCombatPay));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZNonTaxableCombatPay).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZNonTaxableCombatPay.g.xaml") || resource.Equals("F1040EZNonTaxableCombatPay.g.xaml"))) {
                    return resource;
                }
            }
