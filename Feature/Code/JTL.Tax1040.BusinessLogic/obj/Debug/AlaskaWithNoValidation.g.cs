...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities.CalculationWithNoValidation {
    ...
    public partial class AlaskaWithNoValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _AlaskaPermanentFund;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<double> AlaskaPermanentFund {
            get {
                return this._AlaskaPermanentFund;
            }
            set {
                this._AlaskaPermanentFund = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AlaskaWithNoValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AlaskaWithNoValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(AlaskaWithNoValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AlaskaWithNoValidation.g.xaml") || resource.Equals("AlaskaWithNoValidation.g.xaml"))) {
                    return resource;
                }
            }
