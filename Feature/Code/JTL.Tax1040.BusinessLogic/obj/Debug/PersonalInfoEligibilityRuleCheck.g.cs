...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities.CalculationWithNoValidation {
    ...
    public partial class PersonalInfoEligibilityRuleCheck : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public PersonalInfoEligibilityRuleCheck() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(PersonalInfoEligibilityRuleCheck).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(PersonalInfoEligibilityRuleCheck));
        ...
        private string FindResource() {
            string[] resources = typeof(PersonalInfoEligibilityRuleCheck).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".PersonalInfoEligibilityRuleCheck.g.xaml") || resource.Equals("PersonalInfoEligibilityRuleCheck.g.xaml"))) {
                    return resource;
                }
            }
