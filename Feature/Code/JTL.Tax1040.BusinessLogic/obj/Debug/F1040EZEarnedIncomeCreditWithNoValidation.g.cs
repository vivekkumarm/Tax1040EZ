...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities {
    ...
    public partial class F1040EZEarnedIncomeCreditWithNoValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _TotalEIC;
        
        private System.Activities.InOutArgument<int> _EICOut;
...
partial void AfterInitializeComponent();
        ...
        public F1040EZEarnedIncomeCreditWithNoValidation() {
        ...
        public System.Activities.OutArgument<double> TotalEIC {
            get {
                return this._TotalEIC;
            }
            set {
                this._TotalEIC = value;
            }
        }
        
        public System.Activities.InOutArgument<int> EICOut {
            get {
                return this._EICOut;
            }
            set {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZEarnedIncomeCreditWithNoValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZEarnedIncomeCreditWithNoValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZEarnedIncomeCreditWithNoValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZEarnedIncomeCreditWithNoValidation.g.xaml") || resource.Equals("F1040EZEarnedIncomeCreditWithNoValidation.g.xaml"))) {
                    return resource;
                }
            }
