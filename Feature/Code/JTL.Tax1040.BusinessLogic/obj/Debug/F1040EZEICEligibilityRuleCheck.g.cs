...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1040EZEICEligibilityRuleCheck : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F1040EZEICEligibilityRuleCheck() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZEICEligibilityRuleCheck).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZEICEligibilityRuleCheck));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZEICEligibilityRuleCheck).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZEICEligibilityRuleCheck.g.xaml") || resource.Equals("F1040EZEICEligibilityRuleCheck.g.xaml"))) {
                    return resource;
                }
            }
