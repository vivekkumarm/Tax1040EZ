...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1099INTCalculation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1099INTCalculation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1099INTCalculation));
        ...
        private string FindResource() {
            string[] resources = typeof(F1099INTCalculation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1099INTCalculation.g.xaml") || resource.Equals("F1099INTCalculation.g.xaml"))) {
                    return resource;
                }
            }
