...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class FW2BusinessRuleValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public FW2BusinessRuleValidation() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(FW2BusinessRuleValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(FW2BusinessRuleValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(FW2BusinessRuleValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".FW2BusinessRuleValidation.g.xaml") || resource.Equals("FW2BusinessRuleValidation.g.xaml"))) {
                    return resource;
                }
            }
