...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1040EZLineByLineCalculation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F1040EZLineByLineCalculation() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZLineByLineCalculation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZLineByLineCalculation));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZLineByLineCalculation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZLineByLineCalculation.g.xaml") || resource.Equals("F1040EZLineByLineCalculation.g.xaml"))) {
                    return resource;
                }
            }
