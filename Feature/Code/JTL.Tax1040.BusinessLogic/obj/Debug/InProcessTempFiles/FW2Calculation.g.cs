...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class FW2Calculation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(FW2Calculation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(FW2Calculation));
        ...
        private string FindResource() {
            string[] resources = typeof(FW2Calculation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".FW2Calculation.g.xaml") || resource.Equals("FW2Calculation.g.xaml"))) {
                    return resource;
                }
            }
