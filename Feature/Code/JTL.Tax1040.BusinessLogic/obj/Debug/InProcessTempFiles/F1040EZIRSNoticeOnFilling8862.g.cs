...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1040EZIRSNoticeOnFilling8862 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F1040EZIRSNoticeOnFilling8862() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZIRSNoticeOnFilling8862).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZIRSNoticeOnFilling8862));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZIRSNoticeOnFilling8862).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZIRSNoticeOnFilling8862.g.xaml") || resource.Equals("F1040EZIRSNoticeOnFilling8862.g.xaml"))) {
                    return resource;
                }
            }
