...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities {
    ...
    public partial class TaxAndWrapUpEligibilityCheck : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public TaxAndWrapUpEligibilityCheck() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(TaxAndWrapUpEligibilityCheck).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(TaxAndWrapUpEligibilityCheck));
        ...
        private string FindResource() {
            string[] resources = typeof(TaxAndWrapUpEligibilityCheck).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".TaxAndWrapUpEligibilityCheck.g.xaml") || resource.Equals("TaxAndWrapUpEligibilityCheck.g.xaml"))) {
                    return resource;
                }
            }
