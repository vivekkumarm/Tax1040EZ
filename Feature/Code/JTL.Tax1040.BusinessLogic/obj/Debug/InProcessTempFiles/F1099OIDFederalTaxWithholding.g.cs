...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1099OIDFederalTaxWithholding : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _Total1099OIDFederalTaxWithhold;
...
partial void AfterInitializeComponent();
        ...
        public F1099OIDFederalTaxWithholding() {
        ...
        public System.Activities.OutArgument<double> Total1099OIDFederalTaxWithhold {
            get {
                return this._Total1099OIDFederalTaxWithhold;
            }
            set {
                this._Total1099OIDFederalTaxWithhold = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1099OIDFederalTaxWithholding).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1099OIDFederalTaxWithholding));
        ...
        private string FindResource() {
            string[] resources = typeof(F1099OIDFederalTaxWithholding).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1099OIDFederalTaxWithholding.g.xaml") || resource.Equals("F1099OIDFederalTaxWithholding.g.xaml"))) {
                    return resource;
                }
            }
