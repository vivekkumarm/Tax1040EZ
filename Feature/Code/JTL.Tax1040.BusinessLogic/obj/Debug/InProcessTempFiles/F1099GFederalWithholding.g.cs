...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1099GFederalWithholding : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _Total1099GFederalTaxWithhold;
...
partial void AfterInitializeComponent();
        ...
        public F1099GFederalWithholding() {
        ...
        public System.Activities.OutArgument<double> Total1099GFederalTaxWithhold {
            get {
                return this._Total1099GFederalTaxWithhold;
            }
            set {
                this._Total1099GFederalTaxWithhold = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1099GFederalWithholding).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1099GFederalWithholding));
        ...
        private string FindResource() {
            string[] resources = typeof(F1099GFederalWithholding).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1099GFederalWithholding.g.xaml") || resource.Equals("F1099GFederalWithholding.g.xaml"))) {
                    return resource;
                }
            }
