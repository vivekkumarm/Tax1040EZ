...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities {
    ...
    public partial class PersonalInfoBusinessRuleValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public PersonalInfoBusinessRuleValidation() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(PersonalInfoBusinessRuleValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(PersonalInfoBusinessRuleValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(PersonalInfoBusinessRuleValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".PersonalInfoBusinessRuleValidation.g.xaml") || resource.Equals("PersonalInfoBusinessRuleValidation.g.xaml"))) {
                    return resource;
                }
            }
