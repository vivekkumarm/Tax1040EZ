...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1040EZTaxAmountCalculation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.OutArgument<double> _TotalTaxAmount;
...
partial void AfterInitializeComponent();
        ...
        public F1040EZTaxAmountCalculation() {
        ...
        public System.Activities.OutArgument<double> TotalTaxAmount {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZTaxAmountCalculation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZTaxAmountCalculation));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZTaxAmountCalculation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZTaxAmountCalculation.g.xaml") || resource.Equals("F1040EZTaxAmountCalculation.g.xaml"))) {
                    return resource;
                }
            }
