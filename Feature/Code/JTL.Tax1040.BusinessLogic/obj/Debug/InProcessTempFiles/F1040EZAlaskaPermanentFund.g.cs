...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1040EZAlaskaPermanentFund : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _AlaskaPermanantFund;
...
partial void AfterInitializeComponent();
        ...
        public F1040EZAlaskaPermanentFund() {
        ...
        public System.Activities.OutArgument<double> AlaskaPermanantFund {
            get {
                return this._AlaskaPermanantFund;
            }
            set {
                this._AlaskaPermanantFund = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZAlaskaPermanentFund).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZAlaskaPermanentFund));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZAlaskaPermanentFund).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZAlaskaPermanentFund.g.xaml") || resource.Equals("F1040EZAlaskaPermanentFund.g.xaml"))) {
                    return resource;
                }
            }
