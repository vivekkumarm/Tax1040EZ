...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class FSSAFederalTaxWithHolding : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _TotalSSBWithHolding;
...
partial void AfterInitializeComponent();
        ...
        public FSSAFederalTaxWithHolding() {
        ...
        public System.Activities.OutArgument<double> TotalSSBWithHolding {
            get {
                return this._TotalSSBWithHolding;
            }
            set {
                this._TotalSSBWithHolding = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(FSSAFederalTaxWithHolding).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(FSSAFederalTaxWithHolding));
        ...
        private string FindResource() {
            string[] resources = typeof(FSSAFederalTaxWithHolding).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".FSSAFederalTaxWithHolding.g.xaml") || resource.Equals("FSSAFederalTaxWithHolding.g.xaml"))) {
                    return resource;
                }
            }
