...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1099SSBBusinessValidationRule : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F1099SSBBusinessValidationRule() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1099SSBBusinessValidationRule).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1099SSBBusinessValidationRule));
        ...
        private string FindResource() {
            string[] resources = typeof(F1099SSBBusinessValidationRule).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1099SSBBusinessRuleValidation.g.xaml") || resource.Equals("F1099SSBBusinessRuleValidation.g.xaml"))) {
                    return resource;
                }
            }
