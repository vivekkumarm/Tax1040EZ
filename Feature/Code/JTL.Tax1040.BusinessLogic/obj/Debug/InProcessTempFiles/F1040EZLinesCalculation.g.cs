...
public partial class F1040EZLinesCalculation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
    ...
    public F1040EZLinesCalculation() {
    ...
    public void InitializeComponent() {
        ...
        System.IO.Stream initializeXaml = typeof(F1040EZLinesCalculation).Assembly.GetManifestResourceStream(resourceName);
        ...
        try {
            ...
            writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZLinesCalculation));
    ...
    private string FindResource() {
        string[] resources = typeof(F1040EZLinesCalculation).Assembly.GetManifestResourceNames();
        for (int i = 0; (i < resources.Length); i = (i + 1)) {
            string resource = resources[i];
            if ((resource.Contains(".F1040EZLinesCalculation.g.xaml") || resource.Equals("F1040EZLinesCalculation.g.xaml"))) {
                return resource;
            }
        }
