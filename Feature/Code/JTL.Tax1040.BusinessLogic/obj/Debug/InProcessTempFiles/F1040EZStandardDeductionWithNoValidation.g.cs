...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities.CalculationWithNoValidation {
    ...
    public partial class F1040EZStandardDeductionWithNoValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _TotalWorksheetStandardDeduction;
...
partial void AfterInitializeComponent();
        ...
        public F1040EZStandardDeductionWithNoValidation() {
        ...
        public System.Activities.OutArgument<double> TotalWorksheetStandardDeduction {
            get {
                return this._TotalWorksheetStandardDeduction;
            }
            set {
                this._TotalWorksheetStandardDeduction = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZStandardDeductionWithNoValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZStandardDeductionWithNoValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZStandardDeductionWithNoValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZStandardDeductionWithNoValidation.g.xaml") || resource.Equals("F1040EZStandardDeductionWithNoValidation.g.xaml"))) {
                    return resource;
                }
            }
