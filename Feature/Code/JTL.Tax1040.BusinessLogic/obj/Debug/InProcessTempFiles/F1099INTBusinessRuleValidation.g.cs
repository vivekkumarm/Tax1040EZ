...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1099INTBusinessValidationRules : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F1099INTBusinessValidationRules() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1099INTBusinessValidationRules).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1099INTBusinessValidationRules));
        ...
        private string FindResource() {
            string[] resources = typeof(F1099INTBusinessValidationRules).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1099INTBusinessRuleValidation.g.xaml") || resource.Equals("F1099INTBusinessRuleValidation.g.xaml"))) {
                    return resource;
                }
            }
