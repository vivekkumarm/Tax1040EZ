...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1099OIDBusinessValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F1099OIDBusinessValidation() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1099OIDBusinessValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1099OIDBusinessValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(F1099OIDBusinessValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1099OIDBusinessRuleValidation.g.xaml") || resource.Equals("F1099OIDBusinessRuleValidation.g.xaml"))) {
                    return resource;
                }
            }
