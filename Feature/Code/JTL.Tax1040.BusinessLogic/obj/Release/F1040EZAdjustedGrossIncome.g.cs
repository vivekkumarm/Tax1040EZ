...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities {
    ...
    public partial class F1040EZAdjustedGrossIncome : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F1040EZAdjustedGrossIncome() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZAdjustedGrossIncome).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZAdjustedGrossIncome));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZAdjustedGrossIncome).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZAdjustedGrossIncome.g.xaml") || resource.Equals("F1040EZAdjustedGrossIncome.g.xaml"))) {
                    return resource;
                }
            }
