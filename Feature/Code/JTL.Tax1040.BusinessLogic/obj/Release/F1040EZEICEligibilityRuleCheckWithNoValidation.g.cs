...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities.CalculationWithNoValidation {
    ...
    public partial class F1040EZEICEligibilityRuleCheckWithNoValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F1040EZEICEligibilityRuleCheckWithNoValidation() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZEICEligibilityRuleCheckWithNoValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZEICEligibilityRuleCheckWithNoValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZEICEligibilityRuleCheckWithNoValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZEICEligibilityRuleCheckWithNoValidation.g.xaml") || resource.Equals("F1040EZEICEligibilityRuleCheckWithNoValidation.g.xaml"))) {
                    return resource;
                }
            }
