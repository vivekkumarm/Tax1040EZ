...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities.CalculationWithNoValidation {
    ...
    public partial class F1099GWithNoValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _UnEmployment;
        
        private System.Activities.OutArgument<double> _TotalRepaidForCurrentYear;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<double> UnEmployment {
            get {
                return this._UnEmployment;
            }
            set {
                this._UnEmployment = value;
            }
        }
        
        public System.Activities.OutArgument<double> TotalRepaidForCurrentYear {
            get {
                return this._TotalRepaidForCurrentYear;
            }
            set {
                this._TotalRepaidForCurrentYear = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1099GWithNoValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1099GWithNoValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(F1099GWithNoValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1099GWithNoValidation.g.xaml") || resource.Equals("F1099GWithNoValidation.g.xaml"))) {
                    return resource;
                }
            }
