...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F8862BusinessRuleValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F8862BusinessRuleValidation() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F8862BusinessRuleValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F8862BusinessRuleValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(F8862BusinessRuleValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F8862BusinessRuleValidation.g.xaml") || resource.Equals("F8862BusinessRuleValidation.g.xaml"))) {
                    return resource;
                }
            }
