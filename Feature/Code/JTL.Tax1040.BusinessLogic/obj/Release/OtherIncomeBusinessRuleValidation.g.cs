...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities {
    ...
    public partial class OtherIncomeBusinessRuleValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public OtherIncomeBusinessRuleValidation() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(OtherIncomeBusinessRuleValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(OtherIncomeBusinessRuleValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(OtherIncomeBusinessRuleValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".OtherIncomeBusinessRuleValidation.g.xaml") || resource.Equals("OtherIncomeBusinessRuleValidation.g.xaml"))) {
                    return resource;
                }
            }
