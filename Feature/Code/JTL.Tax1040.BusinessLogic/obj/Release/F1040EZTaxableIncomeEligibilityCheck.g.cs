...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities {
    ...
    public partial class F1040EZTaxableIncomeEligibilityCheck : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.OutArgument<double> _TaxableIncome;
...
partial void AfterInitializeComponent();
        ...
        public F1040EZTaxableIncomeEligibilityCheck() {
        ...
        public System.Activities.OutArgument<double> TaxableIncome {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZTaxableIncomeEligibilityCheck).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZTaxableIncomeEligibilityCheck));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZTaxableIncomeEligibilityCheck).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZTaxableIncomeEligibilityCheck.g.xaml") || resource.Equals("F1040EZTaxableIncomeEligibilityCheck.g.xaml"))) {
                    return resource;
                }
            }
