...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class Form1040EZTaxableInterestEligibility : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public Form1040EZTaxableInterestEligibility() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Form1040EZTaxableInterestEligibility).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Form1040EZTaxableInterestEligibility));
        ...
        private string FindResource() {
            string[] resources = typeof(Form1040EZTaxableInterestEligibility).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Form1040EZTaxableInterestEligibility.g.xaml") || resource.Equals("Form1040EZTaxableInterestEligibility.g.xaml"))) {
                    return resource;
                }
            }
