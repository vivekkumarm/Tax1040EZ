...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class F1099RRBBusinessValidationRule : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F1099RRBBusinessValidationRule() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1099RRBBusinessValidationRule).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1099RRBBusinessValidationRule));
        ...
        private string FindResource() {
            string[] resources = typeof(F1099RRBBusinessValidationRule).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1099RRBBusinessRuleValidation.g.xaml") || resource.Equals("F1099RRBBusinessRuleValidation.g.xaml"))) {
                    return resource;
                }
            }
