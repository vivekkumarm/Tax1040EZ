...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities.CalculationWithNoValidation {
    ...
    public partial class Form1040EZSSBEligibilityWithNoValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public Form1040EZSSBEligibilityWithNoValidation() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Form1040EZSSBEligibilityWithNoValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Form1040EZSSBEligibilityWithNoValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(Form1040EZSSBEligibilityWithNoValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Form1040EZSSBEligibilityWithNoValidation.g.xaml") || resource.Equals("Form1040EZSSBEligibilityWithNoValidation.g.xaml"))) {
                    return resource;
                }
            }
