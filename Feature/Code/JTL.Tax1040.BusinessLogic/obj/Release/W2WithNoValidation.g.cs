...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities.CalculationWithNoValidation {
    ...
    public partial class W2WithNoValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _TotalWages;
        
        private System.Activities.OutArgument<string> _PrefixTotalWages;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<double> TotalWages {
            get {
        ...
        public System.Activities.OutArgument<string> PrefixTotalWages {
            get {
                return this._PrefixTotalWages;
            }
            set {
                this._PrefixTotalWages = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(W2WithNoValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(W2WithNoValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(W2WithNoValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".W2WithNoValidation.g.xaml") || resource.Equals("W2WithNoValidation.g.xaml"))) {
                    return resource;
                }
            }
