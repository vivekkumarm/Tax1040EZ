...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class Form1040EZSSBEligiblity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public Form1040EZSSBEligiblity() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Form1040EZSSBEligiblity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Form1040EZSSBEligiblity));
        ...
        private string FindResource() {
            string[] resources = typeof(Form1040EZSSBEligiblity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Form1040EZSSBEligiblity.g.xaml") || resource.Equals("Form1040EZSSBEligiblity.g.xaml"))) {
                    return resource;
                }
            }
