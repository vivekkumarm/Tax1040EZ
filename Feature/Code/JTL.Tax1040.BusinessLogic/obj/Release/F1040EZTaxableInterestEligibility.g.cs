...
namespace JTL.Tax1040.BusinessLogic.WorkFlow.Activities {
    ...
    public partial class F1040EZTaxableInterestEligibility : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public F1040EZTaxableInterestEligibility() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(F1040EZTaxableInterestEligibility).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EZTaxableInterestEligibility));
        ...
        private string FindResource() {
            string[] resources = typeof(F1040EZTaxableInterestEligibility).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".F1040EZTaxableInterestEligibility.g.xaml") || resource.Equals("F1040EZTaxableInterestEligibility.g.xaml"))) {
                    return resource;
                }
            }
