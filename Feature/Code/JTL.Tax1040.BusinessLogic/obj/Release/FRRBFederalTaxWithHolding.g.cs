...
namespace Tax1040WorkFlow.WorkFlow.Activities {
    ...
    public partial class FRRBFederalTaxWithHolding : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<JTL.Tax1040.BusinessObject.Tax1040> _Tax1040Object;
        
        private System.Activities.OutArgument<double> _TotalRRBWithHolding;
...
partial void AfterInitializeComponent();
        ...
        public FRRBFederalTaxWithHolding() {
        ...
        public System.Activities.OutArgument<double> TotalRRBWithHolding {
            get {
                return this._TotalRRBWithHolding;
            }
            set {
                this._TotalRRBWithHolding = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(FRRBFederalTaxWithHolding).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(FRRBFederalTaxWithHolding));
        ...
        private string FindResource() {
            string[] resources = typeof(FRRBFederalTaxWithHolding).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".FRRBFederalTaxWithHolding.g.xaml") || resource.Equals("FRRBFederalTaxWithHolding.g.xaml"))) {
                    return resource;
                }
            }
