...
public partial class F1040EzEligibilityRuleCheck : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
    ...
    public F1040EzEligibilityRuleCheck() {
    ...
    public void InitializeComponent() {
        ...
        System.IO.Stream initializeXaml = typeof(F1040EzEligibilityRuleCheck).Assembly.GetManifestResourceStream(resourceName);
        ...
        try {
            ...
            writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(F1040EzEligibilityRuleCheck));
    ...
    private string FindResource() {
        string[] resources = typeof(F1040EzEligibilityRuleCheck).Assembly.GetManifestResourceNames();
        for (int i = 0; (i < resources.Length); i = (i + 1)) {
            string resource = resources[i];
            if ((resource.Contains(".F1040EzEligibilityRuleCheck.g.xaml") || resource.Equals("F1040EzEligibilityRuleCheck.g.xaml"))) {
                return resource;
            }
        }
