    ...
    public class EFileRepository : IEFileRepository
    {
        ...
        public dynamic GetFilingOptionSummary(UserDTO userDTO)
        {
            ...
            try
            {
                ...
                //18aug2014 Sathish returned Tax payer name to bind in filing option summary Spec 1.5
                userData.TaxPayerFirstNameOrNickName = Utilities.GetTaxPayerFirstNameOrNickName(taxObject);
        ...
        public long PersistIRSTransmissionEfile(long userId, JTL.Tax1040.BusinessObject.Tax1040 taxObject, EfileErrorCollection efileerrorcollection)
        {
            ...
            try
            {
                ...
                if (!taxObject.ErrorMessages.Any(em => em.Topic.Equals(Constants.TOPIC_FILING)))
                {
        ...
        public dynamic PersistIRSTranmission(long userId, TaxReturnData taxReturnData)
        {
            ...
            try
            {
                ...
                //persist tax object
                //22Aug2014 Sathish checked error count equal to zeror before persist
                if (!taxObject.ErrorMessages.Any(em => em.Topic.Equals(Constants.TOPIC_FILING)))
