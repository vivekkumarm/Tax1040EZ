...
namespace JTL.Tax1040.WebApi
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
         ...
         defaults: new
         {
            ...
            config.Routes.MapHttpRoute(
                 name: "GetPersonInfoErrorList",
                 routeTemplate: "personalinfo/getprimarytaxpayerwitherrorlist",
                 defaults: new
                 {
                     Controller = "PersonalInfo",
                     action = "GetPrimaryTaxPayerAndErrorList"
                 }
               ,
               constraints: null,
               handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
                            name: "GetCurrentPersonalSection",
                            routeTemplate: "personalinfo/getcurrentpersonalsection",
                            defaults: new
                            {
                                Controller = "PersonalInfo",
                                action = "GetCurrentPersonalSection"
                            },
                          constraints: null,
                          handler: tokenInspector
                            );
      ...
      defaults: new
      {
          ...
          action = "PersistOtherIncome"
           ...
           defaults: new
           {
            ...
            config.Routes.MapHttpRoute(
          name: "GetFederalSummaryDetails",
          routeTemplate: "taxreturn/getfederalsummarydetails",
          defaults: new
          {
              Controller = "TaxReturn",
              action = "GetFederalSummaryDetails"
          }
               ,
              constraints: null,
              handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
            name: "GetTaxSummary",
            routeTemplate: "taxreturn/gettaxsummary",
            defaults: new
            {
                Controller = "TaxReturn",
    ...
    defaults: new { id = RouteParameter.Optional }
            ...
            config.Routes.MapHttpRoute(
                    name: "GetHasEarnedIncomeCredits",
                    routeTemplate: "earnedincomecredit/gethasearnedincomecredits",
                    defaults: new
                    {
                        Controller = "EarnedIncomeCredit",
                        action = "GetHasEarnedIncomeCredits"
                    },
                 constraints: null,
                 handler: tokenInspector
                    );
            ...
            config.Routes.MapHttpRoute(
                    name: "PersistResidenttype",
                    routeTemplate: "stategateway/persistResidentTypeConfirmation",
                   defaults: new
                   {
                       Controller = "StateGateway",
                       action = "PersistResidentTypeConfirmation"
                   }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            /* 24July2014 Ashok Kumar added routeConfig to retrieve only the supporting states of Tax1040product*/
            config.Routes.MapHttpRoute(
                 name: "GetAllSupportingState",
                 routeTemplate: "stategateway/getallsupportingstate",
                 defaults: new
                 {
                     Controller = "StateGateway",
                     action = "GetAllSupportingState"
                 },
                constraints: null,
                handler: tokenInspector
             );
            ...
            config.Routes.MapHttpRoute(
                    name: "GetFederalReturnSKU",
                    routeTemplate: "payment/getfederalreturnsku",
                    defaults: new
                    {
                        Controller = "Payment",
                        action = "GetFederalReturnSKU"
                    }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
                name: "GetUserFeatureSKU",
                routeTemplate: "payment/getuserfeaturesku",
                defaults: new
                {
                    Controller = "Payment",
                    action = "GetUserFeatureSKU"
                }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
                name: "PersistUserFeature",
                routeTemplate: "payment/persistuserfeature",
                defaults: new
                {
                    Controller = "Payment",
                    action = "PersistUserFeature"
                }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
             ...
             routeTemplate: "efile/geterrormessage",
             defaults: new
             {
                 Controller = "EFile",
            ...
            config.Routes.MapHttpRoute(
            name: "GetEFilingOption",
            routeTemplate: "efile/getefilingoption",
            defaults: new
            {
                Controller = "EFile",
                action = "GetEFilingOption"
            }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
             name: "DeleteEfileInformation",
             routeTemplate: "efile/deleteefileinformation",
             defaults: new
             {
                 Controller = "EFile",
                 action = "DeleteEfileInformation"
             }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
            name: "DeleteIRSTransmissionDetail",
            routeTemplate: "efile/deleteirstransmissiondetail",
            defaults: new
            {
                Controller = "EFile",
                action = "DeleteIRSTransmissionDetail"
            }
               ,
               constraints: null,
               handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
                    ...
                    routeTemplate: "efile/getirspaymentoption",
                    defaults: new
                    {
                        Controller = "EFile",
            ...
            config.Routes.MapHttpRoute(
                    name: "PersistIRSPaymentOption",
                    routeTemplate: "efile/persistirspaymentoption",
                    defaults: new
                    {
                        Controller = "EFile",
                        action = "PersistIRSPaymentOption"
                    }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            //Vincent 3July2014  Added GetFilingOptionSummary for Web api.
            config.Routes.MapHttpRoute(
                    name: "GetFilingOptionSummary",
                    routeTemplate: "efile/getfilingoptionsummary",
                    defaults: new
                    {
                        Controller = "EFile",
                        action = "GetFilingOptionSummary"
                    }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            //vivek 2-july-14 for IRS transmission persist
            config.Routes.MapHttpRoute(
             name: "PersistFiling",
             routeTemplate: "efile/persistfiling",
             defaults: new
             {
                 Controller = "EFile",
                 action = "PersistFiling"
             }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            //Vincent-10JULY 2014 - Added web API method for  Persist irs tranmission

            config.Routes.MapHttpRoute(
             name: "PersistIRSTranmission",
             routeTemplate: "efile/persistirstransmission",
             defaults: new
             {
                 Controller = "EFile",
                 action = "PersistIRSTransmission"
             }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
                name: "GetIRSReturnStatus",
                routeTemplate: "efile/getirsreturnstatus",
                defaults: new
                {
                    Controller = "EFile",
                    action = "GetIRSReturnStatus"
                }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
            name: "GetEfileErrorMessage",
            routeTemplate: "efile/getEfileerrormessage",
            defaults: new
            {
                Controller = "EFile",
                action = "GetEfileErrorMessage"
            }
               ,
               constraints: null,
               handler: tokenInspector
            );
            //Vincent 3July2014 -Removed the duplicate method in efile web api

            #region E-Mail
            //vivek 11-july-214 Added for the email transmission
            config.Routes.MapHttpRoute(
            name: "EMail",
            routeTemplate: "efile/email",
             defaults: new
             {
                 Controller = "EFile",
                 action = "EMail"
            ...
            config.Routes.MapHttpRoute(
                     name: "GetUserRating",
                     routeTemplate: "taxreturn/getuserrating",
                     defaults: new
                     {
                         Controller = "TaxReturn",
            ...
            config.Routes.MapHttpRoute(
                              name: "PersistUserRating",
                              routeTemplate: "taxreturn/persistuserrating",
                              defaults: new
                              {
                                  Controller = "TaxReturn",
                                  action = "PersistUserRating"
                              }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
                              name: "PersistUserReferral",
                              routeTemplate: "taxreturn/persistuserreferral",
                              defaults: new
                              {
                                  Controller = "TaxReturn",
                                  action = "PersistUserReferral"
                              }
                ,
                constraints: null,
                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
                 name: "GetStatePaymentDetail",
                 routeTemplate: "efile/getstatepaymentdetail",
                 defaults: new
                 {
                     Controller = "EFile",
                     action = "GetStatePaymentDetail"
                 }
                                ,
                                constraints: null,
                                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
                   name: "GetPersonAndStateTransmission",
                   routeTemplate: "efile/getpersonandstatetransmission",
                   defaults: new
                   {
                       Controller = "EFile",
                       action = "GetPersonAndStateTransmission"
                   }
                                  ,
                                  constraints: null,
                                  handler: tokenInspector
            ...
            #region Persist
            config.Routes.MapHttpRoute(
                 name: "PersistStatePaymentDetail",
                 routeTemplate: "efile/persiststatepaymentdetail",
                 defaults: new
                 {
                     Controller = "EFile",
                     action = "PersistStatePaymentDetail"
                 }
                                ,
                                constraints: null,
                                handler: tokenInspector
            ...
            config.Routes.MapHttpRoute(
                       name: "PersistStateTranmission",
                       routeTemplate: "efile/persiststatetranmission",
                       defaults: new
                       {
                           Controller = "EFile",
                           action = "PersistStateTranmission"
                       }
                                      ,
                                      constraints: null,
                                      handler: tokenInspector
          ...
          defaults: new
          {
            ...
            //TODO : Have to map with CA Controller for CA State.
