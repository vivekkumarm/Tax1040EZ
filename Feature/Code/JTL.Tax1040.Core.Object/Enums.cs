...
namespace JTL.Tax1040.Core.Object
{
    ...
    public enum EmployerCode
    {
        ...
        //Yogalakshmi - 27th August 2014 - Removed the Enum as it is not needed for PDF binding
        ////Yogalakshmi - 19th August 2014 - Added a new Enum Empty.
        //[Description("")]
        //EmptyString = 27
    ...
    #region CA
    //02Sep2014 Sathish added Military Indicator Enum for State
    public enum MilitaryIndicator
    {
        [Description("None")]
        None = 0,
        [Description("Military Overseas")]
        MilitaryOverseas = 1,
        [Description("Combat Zone/ QHDA")]
        CombatZoneQHDA = 2,
        [Description("National Guard")]
        NationalGuard = 3
    }

    //02Sep2014 Sathish added Enum CA Address Unit  for CA
    public enum CAAddressUnit 
    {
        [Description("APT - Apartment")]
        Apartment = 0,
        [Description("BLDG - Building")]
        Building = 1,
        [Description("FL - Floor")]
        Floor = 2,
        [Description("RM - Room")]
        Room = 3,
        [Description("SP - Space")]
        Space = 4,
        [Description("STE - Suite")]
        Suite = 5,
        [Description("UN - Unit")]
        Unit = 6
    }
