 ...
 * 10Jul2014 Sathish added constants for EIC Eligibility check
 * 28 July 2014 Swapnesh - Changes done to display all Income diagnostics
 * 28July2014-Constants for EIC Added to display Eligiblity Information(EI) error messages as per Credit Spec(Version V1.5) by Thileep
 * 31July2014-Constants for EIC Added to display Eligiblity Information(EI) error messages as per Credit Spec(Version V1.6) by Ashok kumar
 * 11August2014 Ashok Kumar - Removed Constants of EIC Business Rules removed which are available in EIC Information Type
 */
...
namespace JTL.Tax1040.Core.Object
{
    public sealed class Constants
    {
        ...
        //14 Aug 14 vivek added for the address business rule
        public const string CITY_NAME_APO = "APO";
        public const string CITY_NAME_FPO = "FPO";
        public const string CITY_NAME_DPO = "DPO";
        public const int STATE_ARMED_FORCES_AFRICA  = 53;
        public const int STATE_ARMED_FORCES_CANADA = 54;
        public const int STATE_ARMED_FORCES_EUROPE = 55;
        public const int STATE_ARMED_FORCES_MIDDLE_EAST = 56;
        public const int STATE_ARMED_FORCES_AMERICAS = 52;
        public const int STATE_ARMED_FORCES_PACIFIC = 57;
        // 28May2014 Sathish added TAXABLE_INCOME constant to check tax able income eligibility
        public const double TAXABLE_INCOME_ELIGIBILITY_AMOUNT = 100000;

        // 10Jul2014 Sathish added constants for EIC Eligibility check
        public const int EIC_MIN_AGE = 25;
        public const int EIC_MAX_AGE = 65;
        public const int EIC_SINGLE_ADJUSTED_GROSS_INCOME = 14339;
        public const int EIC_MFJ_ADJUSTED_GROSS_INCOME = 19679;
        ...
        public const int ZIP_CODE_RANGE = 9;

        //26AUG14 Bala, Zip code added for PersonalInfo spec updation(V2.8).
        public const string VALID_ZIP_CODE1 = "00800";
        public const string VALID_ZIP_CODE2 = "20500";
        public const string VALID_ZIP_CODE3 = "34000";
        public const string VALID_ZIP_CODE4 = "00600";
        public const string VALID_ZIP_CODE5 = "96100";
        public const string VALID_ZIP_CODE6 = "96900";
        public const string TWO_ZEROS = "00";


        //8 july 2014 vivek Added for the date formate
        public const string TAX_PAYER_DATE_FORMATE = "PrimaryFiler_V10";
        public const string SPOUSE_DATE_FORMATE = "Spouse_V9";
        ...
        //30July2014-Thileep Added EI messagetype to Get EligiblityInformation Messages in Credit Section
        public const string MESSAGE_TYPE_EI = "EI";

        // encrypted key to efile 
       ...
       //Vincent - 8/7/14- Added a new constant for served in military for Spouse
        ...
        //Bala, 4Aug14 Added validation based on the sepc updation
        public const string SPOUSE_TAXPAYER_SSN_SAME = "Spouse_V10";
        public const string SPOUSE_TAXPAYER_RESIDENT_STATE_SAME = "Spouse_V11";
        ...
        public const string TAXPAYER_FOREIGN_ADDRESS_POSTAL_CODE = "Address_V18";
        ...
        public const string TAXPAYER_PERSONAL_ADDRESS_APARTMENT_NUMBER = "Address_V11";
        ...
        public const string TAXPAYER_FOREIGN_ADDRESS_APARTMENT_NUMBER = "Address_V17";

        public const string TAXPAYER_ADDRESS_NONRESIDENT_PARTYEARRESIDENT_SAME = "Address_V19";
        //Added new business rule by vincent on 6 Sept 2014.
        public const string TAXPAYER_ADDRESS_ARMED_FORCES_AMERICAS = "Address_BR1";
        public const string TAXPAYER_ADDRESS_SELECTED_STATE_NAME = "Address_BR2";
        public const string TAXPAYER_ADDRESS_ARMED_FORCES_PACIFIC = "Address_BR3";
        public const string TAXPAYER_ADDRESS_ENTERED_CITY_NAME = "Address_BR4";
        //19 Augest 2014-  Vincent- Added a new Constant for addresss
        public const string TAXPAYER_ADDRESS_ENTERED_CITY_NAME_LENGTH = "Address_BR5";
        public const string TAXPAYER_ADDRESS_ENTERED_ANOTHER_CITY_NAME_LENGTH = "Address_BR6";
        ...
        // Bala, 4Aug14, Validation messages removed based on the Spec updation PersonalInfo V2.6
        ...
        //Commented by Ashok Kumar EIC Business Rules which are available in EIC Information Type
        //EIC Eligibility
        ...
        //Thileep Added Constants for EIC
        public const string EIC_NUMBER_OF_DAYS_SPOUSE_LIVED_IN_US_VALID = "EarnedIncomeCredit_V2";
        public const string EIC_NUMBER_OF_DAYS_TAXPAYER_LIVED_IN_US_VALID = "EarnedIncomeCredit_V1";

        //28July2014-Constants for EIC Added to display Eligiblity Information(EI) error messages as per Credit Spec(Version V1.5) by Thileep
        public const string EIC_INFO_FORGOT_TAXPAYER_SSN = "EarnedIncomeCredit_EI1";
        public const string EIC_INFO_FORGOT_TAXPAYER_OR_SPOUSE_SSN = "EarnedIncomeCredit_EI2";
        public const string EIC_INFO_TAXPAYER_CLAIM_DEPENDENT = "EarnedIncomeCredit_EI3";
        public const string EIC_INFO_TAXPAYER_SPOUSE_CLAIM_DEPENDENT = "EarnedIncomeCredit_EI4";
        public const string EIC_INFO_TAXPAYER_AGE_LIMIT = "EarnedIncomeCredit_EI5";
        public const string EIC_INFO_TAXPAYER_SPOUSE_AGE_LIMIT = "EarnedIncomeCredit_EI6";
        public const string EIC_INFO_TAXPAYER_INVESTMENT_INCOME_LIMIT = "EarnedIncomeCredit_EI7";
        //31July2014-Constants for EIC Added to display Eligiblity Information(EI) error messages as per Credit Spec(Version V1.6) by Asho kumar
        public const string EIC_INFO_VALID_TAXPAYER_SSN = "EarnedIncomeCredit_EI8";
        public const string EIC_INFO_HAVE_EARNED_INCOME = "EarnedIncomeCredit_EI9";
        public const string EIC_INFO_TAXPAYER_SPOUSE_AGI_LIMIT = "EarnedIncomeCredit_EI10";
        //20July2014-Constants for EIC Added to display Eligiblity Information(EI) error message as per Credit Spec(Version V1.7) by Thileep kumar
        public const string EIC_INFO_VALID_TAXPAYER_OR_SPOUSE_SSN = "EarnedIncomeCredit_EI11";
        ...
        //Yogalakshmi - 25th August 2014 - Added a new constant for Other Benifits Amount - Defect TAX1040-14475
        public const string WAGES_BENEFITS_OTHER_INFORMATION_AMOUNT = "Wages_RF53";
        ...
        public const string WAGES_EMPLOYER_CITY_VALIDATION = "Wages_V7";  //Yogalakshmi R - 6th Aug, 2014 - Changed as per spec ver 2.6 for new Validation #7. 
        ...
        public const string WAGES_MISSING_FOREIGN_EMPLOYMENT_COMPENSATION = "Wages_RF54";
        ...
        //New Required Field 16, 17, 18 and 19 Error codes added by Yogalakshmi - 6th Aug, 2014.
        public const string INT_STATE_TAX_EXEMPT_AMOUNT = "InterestIncome_RF16";
        public const string INT_STATE_TAX_EXEMPT_STATE_CODE = "InterestIncome_RF17";
        public const string OID_STATE_TAX_EXEMPT_AMOUNT = "InterestIncome_RF18";
        public const string OID_STATE_TAX_EXEMPT_STATE_CODE = "InterestIncome_RF19";
        ...
        public const string F1099G_UnEmploymentCompensation_Validation = "UnemploymentCompensation_V6"; 
        ...
        public const string EMAIL_INVOICENUMBER = "@@invoicenumber";
        public const string EMAIL_ORDERDATE = "@@orderDate";
        public const string EMAIL_USERADDRESS = "@@UserAddress";
        public const string EMAIL_PAYMENTAMOUNT = "@@paymentAmount";
        public const string EMAIL_DYNAMICSTATELIST = "@@dynamicstateList";
        public const string EMAIL_TOTALSTATEPRICE = "@@TotalStatePrice";
        public const string EMAIL_FEDERALTAXPREPARATION = "@@FederaltaxPreparation";
        ...
        public const string INVOICE_SUBJECT = "Invoice for Payment with Tax Garden";

        public const string EFILE_ERROR_TABLE = "efileerrorlist";
        ...
        public const string EnumText = "EnumText";
        ...
        // 19 Aug 2014- Vincent - Added a new constant file for foreign phone number.
        public const string TwentyZeros = "00000000000000000000";
        public const string TwentyNines = "99999999999999999999";
        ...
        //Tab Name
        public const string Tab_PERSONAL_INFO = "PersonalInfo";
        public const string Tab_DEDUCTION_INFO = "Deduction";
        public const string Tab_TAX_AND_WRAPUP = "TaxesAndWrapUp";
        public const string Tab_EARNED_INCOME_CREDITS = "Credits";
        public const string Tab_INCOME = "Income";
        public const string Tab_INCOME_ER = "ER";
        public const string Tab_PRE_LOGIN = "Pre-Login";
        public const string Tab_ACCOUNT_SETTINGS = "ManageAccount";
        public const string TOPIC_SIGN_UP = "Sign-Up";
        public const string TOPIC_SIGN_IN = "Sign-In";
        public const string TOPIC_UPDATE_EMAIL = "UpdateEmail";
        public const string TOPIC_UPDATE_USERNAME = "UpdateUsername";
        public const string TOPIC_UPDATE_USERINFO = "UpdateUserInfo";
        public const string TOPIC_UPDATE_PASSWORD = "UpdatePassword";
        public const string TOPIC_UPDATE_SECURITY_QUESTION = "UpdateSecurityQuestion";
        public const string TOPIC_SIGN_IN_ISSUE = "Sign-In Issues";
        ...
        public const string TOPIC_ERROR = "Error";
        ...
        public const string TOPIC_INCOME_GATEWAY = "IncomeGateway";
        ...
        public const string TOPIC_FILING = "Filing"; //11Aug2014 Sathish changed constant value from Efile to Filing since its related to filing information
        public const string TOPIC_EFILESERVICE = "EfileService";
        ...
        /*12Aug2014 Thileep added error message as per Spec Taxesandwrapup(V1.5)*/
        public const string TAX_AND_WRAP_UP_REQUIRED_REFUND_DETAIL = "TaxesAndWrapUp_RF12";
        public const string TAX_AND_WRAP_UP_MISSING_INCOME = "TaxesAndWrapUp_V12";
        ...
        public const string PAYMENT_REQUIRED_FIRST_NAME = "Payment_RF1";
        public const string PAYMENT_REQUIRED_LAST_NAME = "Payment_RF2";
        public const string PAYMENT_REQUIRED_STREET_ADDRESS = "Payment_RF3";
        public const string PAYMENT_VALIDATION_FIRST_NAME = "Payment_V1";
        ...
        public const string PAYMENT_REQUIRED_CITY = "Payment_RF4";
        public const string PAYMENT_VALIDATION_LAST_NAME = "Payment_V2";
        //public const string PAYMENT_REQUIRED_LAST_NAME = "Payment_RF19";
        public const string PAYMENT_VALIDATION_EMAIL = "Payment_V10";
        public const string PAYMENT_VALIDATION_APARTMENTNUMBER = "Payment_V11";
       // public const string PAYMENT_REQUIRED_STREET_ADDRESS = "Payment_RF3";
        public const string PAYMENT_VALIDATION_STREET_ADDRESS = "Payment_V3";
        public const string PAYMENT_REQUIRED_CITY_NAME = "Payment_RF4";
        public const string PAYMENT_REQUIRED_PHONE_NUMBER = "Payment_RF7";
        public const string PAYMENT_REQUIRED_COUNTRY_CODE = "Payment_RF8";
        public const string PAYMENT_VALIDATION_CITY_NAME = "Payment_V4";
        public const string PAYMENT_VALIDATION_STATE_PROVINCE = "Payment_V5";
        public const string PAYMENT_REQUIRED_ZIP_CODE = "Payment_RF6";
        public const string PAYMENT_REQUIRED_CARD_TYPE = "Payment_RF9";
        public const string PAYMENT_VALIDATION_PHONE_NUMBER = "Payment_V7";
        public const string PAYMENT_REQUIRED_STATE_CODE = "Payment_RF5";
        public const string PAYMENT_VALIDATION_ZIP_CODE = "Payment_V6";
        public const string PAYMENT_REQUIRED_CARD_NUMBER = "Payment_RF10";
        public const string PAYMENT_REQUIRED_CVC = "Payment_RF11";
        public const string PAYMENT_REQUIRED_EXPIRATION_DATE = "Payment_RF12";
        public const string PAYMENT_REQUIRED_EXPIRATION_YEAR = "Payment_RF14"; //22Aug2014 Sathish added constant for Expiration year
        public const string PAYMENT_VALIDATION_CARD_NUMBER = "Payment_V8";
        public const string PAYMENT_VALIDATION_EXPIRATION_DATE = "Payment_V9";
        public const string PAYMENT_VALIDATION_POSTAL_CODE = "Payment_V12"; //01Sep2014 Sathish Postal code validation
        public const string PAYMENT_REQUIRED_EMAIL = "Payment_RF13";
        public const string PAYMENT_VALIDATION_FOREIGN_PHONE_NUMBER = "Payment_V14"; //01Sep2014 Sathish Foreign phone number validation
      ...
      //  public const string PAYMENT_REQUIRED_EXPIRATION_DATE = "Payment_V9";
        ...
        public const string PAYMENT_BUSINESS_RULE_CITY_NAME = "Payment_BR1";  // 25Aug2014 Sathish added business rule for city



        //Efile
        //11Aug2014 sathish value efile to filing
        // 3July2014 Vincent Added constant for required and validation field
        public const string FILING_IRS_PAYEMENT_OPTION_NULL = "Filing_RF10";
        public const string FILING_REQUIRED_PERSONAL_IDENTIFICATION_NUMBER = "Filing_RF11";
        public const string FILING_REQUIRED_TYPE_OF_ACCOUNT = "Filing_RF1";
        public const string FILING_REQUIRED_ACCOUNT_NUMBER = "Filing_RF2";
        public const string FILING_REQUIRED_ROUTING_NUMBER = "Filing_RF3";
        public const string FILING_REQUIRED_BANK_NAME = "Filing_RF4";
        public const string FILING_REQUIRED_INSTRUCTION_DIRECT_DEBIT = "Filing_RF5";
        public const string FILING_REQUIRED_INSTRUCTION_EFTPS = "Filing_RF6";
        public const string FILING_REQUIRED_INSTRUCTION_CHECK_OR_MONEY_ORDER = "Filing_RF7";
        public const string FILING_ROUTING_NUMBER_VALIDATION = "Filing_V1";

        //11July2014 Vincent Added a Constant value for Today Date. 
        public const string FILING_VALIDATION_TODAY_DATE = "Filing_V6";

        //9-july-14 vivek Added by vivek for the efile validation
        public const string FILING_REQUIRED_EMAIL = "Filing_RF9";
        public const string FILING_VALIDATION_EMAIL = "Filing_V2";
        public const string FILING_VALIDATION_PERSONAL_IDENTIFICATION_NUMBER = "Filing_V3";
        public const string FILING_VALIDATION_IDENTITY_PRODECTION_PIN = "Filing_V4";
        public const string FILING_VALIDATION_2013PINHASVALUE_AND_SELFSELECTPINDOESNOTHAVEVALUE = "Filing_V5";
        public const string FILING_VALIDATION_CURRENTDATE = "Filing_V6";
        public const string FILING_REQUIRED_FILED_MODE = "Filing_RF8";
        public const string FILING_REQUIRED_PRIMARY_PIN = "Filing_RF12";
        public const string FILING_REQUIRED_PRIOR_YEAR_AGI = "Filing_RF13";
        public const string FILING_REQUIRED_PRIOR_IRS_DATE = "Filing_RF14";
        public const string FILING_REQUIRED_PRIMARY_IPIN = "Filing_RF15";


        //22July2014-Thileep Added Constants for EFILEOPTION 
        public const string FILING_VALIDATION_SPOUSE_PERSONAL_IDENTIFICATION_NUMBER = "Filing_V7";
        public const string FILING_VALIDATION_PAYER_PRIORYEAR_PERSONAL_IDENTIFICATION_NUMBER = "Filing_V8";
        public const string FILING_VALIDATION_SPOUSE_PRIORYEAR_PERSONAL_IDENTIFICATION_NUMBER = "Filing_V9";
        public const string FILING_VALIDATION_PAYER_EFIN_ISSUEDBYIRS = "Filing_V10";
        public const string FILING_VALIDATION_SPOUSE_EFIN_ISSUEDBYIRS = "Filing_V11";
        public const string FILING_VALIDATION_PAYER_EFIN = "Filing_V13";
        public const string FILING_VALIDATION_SPOUSE_EFIN = "Filing_V14";
        public const string FILING_VALIDATION_SPOUSE_IDENTITY_PRODECTION_PIN = "Filing_V12";
        public const string FILING_VALIDATIONTAX_PAYER_TODAY_DATE_ISSUEDBYIRS = "Filing_V15";
        public const string FILING_VALIDATION_SPOUSE_TODAY_DATE_ISSUEDBYIRS = "Filing_V16";
        public const string FILING_VALIDATION_ACCOUNT_NUMBER = "Filing_V17";
        //public const string EFILE_VALIDATION_SPOUSE_AGI_PIN_TODAY_DATE = "Filing_V18";
        public const string FILING_REQUIRED_PIN_DETAILS = "Filing_RF16";
        public const string FILING_REQUIRED_FILING_DATE = "Filing_RF17";
        public const string FILING_REQUIRED_IRS_PIN = "Filing_RF18";
        public const string FILING_REQUIRED_FILING_OPTION = "Filing_RF19";
        ...
        //Praveen T - 23 July 2014 -Added for Payment
       
        public const string ENVIRONMENT = "ENVIRONMENT";
        public const string API_USERNAME = "API_USERNAME";
        public const string API_PASSWORD = "API_PASSWORD";
        public const string API_SIGNATURE = "API_SIGNATURE";
        public const string MERCHANTSESSIONID = "MERCHANTSESSIONID";
        public const string REMOTE_ADDR = "REMOTE_ADDR";
        public const string MerchantReferenceCode1040EZ = "MerchantReferenceCode1040EZ";
        public const string MERCHANT_ID = "MERCHANT_ID";
        public const string TRANSACTION_KEY = "TRANSACTION_KEY";
        public const string PaymentProcessor = "PaymentProcessor";


        public const string CyberSource = "CyberSource";
        public const string PayPal = "PayPal";
        public const string PaymentAccept = "ACCEPT";
        
        //payment error messages
        public const string RequiredField = "Required field(s) are missing: ";
        public const string FieldInvalid = "Field(s) are invalid: ";
        public const string SystemFailure = "General system failure";
        public const string VerifyAddress = "Please verify your Address/Name and try again";
        public const string InvalidCard = "Invalid card type or does not correlate with the credit card number";
        public const string InvalidCardHolder = "Authenticate the cardholder before continuing with the transaction";
        public const string InvalidCustomer = "Customer cannot be authenticated";
        public const string BankRequest = "The issuing bank has questions about the request";
        public const string CreditCard = "Your credit card has expired. Please contact your credit card issuer";
        public const string PleaseCheck = "General decline of the card. Please use different card.";
        public const string InsufficientFund = "Insufficient funds in the account.";
        public const string InvalidTransaction = "Invalid transaction type.";
        public const string CreditLimit = "The card has reached the credit limit.";
        public const string AccountInvalid = "Credit Card number is invalid.";
        public const string ProcessorDecline = "General Processor decline. Please use different card.";
        
        
        

        public const string MAPPERXML_F1040EZ_FW2_OTHERDEDUCTSBENEFITS_OUTPUTFORM = "JTL.Tax1040.PDFBinding.PdfXmlMappers.FW2OtherDeductsBenefits.xml";
        //Yogalakshmi - 26th June 2014 - Added for Form 1040 V Binding PDF Binding 
        public const string MAPPERXML_F1040EZ_FW2_STATELOCALTAXINFO_OUTPUTFORM = "JTL.Tax1040.PDFBinding.PdfXmlMappers.FW2StateAndLocalInfo.xml";
        public const string MAPPERXML_F1040EZ_FW2_LOCALTAXINFO_OUTPUTFORM = "JTL.Tax1040.PDFBinding.PdfXmlMappers.FW2LocalTaxInfo.xml";
        public const string MAPPERXML_F1040EZ_FW2_EMPLOYERCODE_OUTPUTFORM = "JTL.Tax1040.PDFBinding.PdfXmlMappers.FW2EmployerCode.xml";
        //Yogalakshmi - 15th July 2014 - Added for Form W2 Binding PDF Binding 
        public const string MAPPERXML_F1040EZ_FW2_PRIMARYTAXPAYER_OUTPUTFORM = "JTL.Tax1040.PDFBinding.PdfXmlMappers.FW2PrimaryTaxPayer.xml";
