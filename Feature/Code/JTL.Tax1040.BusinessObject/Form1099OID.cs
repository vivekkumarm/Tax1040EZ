...
namespace JTL.Tax1040.BusinessObject
{
    public class Form1099OID
    {
        ...
        //Vincent- Have to comment the code  for TaxExemptInterestState and StateExemptInterest
        public State TaxExemptInterestState { get; set; } //10Jul2014 Sathish changed to state BO

        //public double? StateExemptInterest { get; set; }

        //Vincent - 25st August 2014 - Added a property for Tax Exempt State code and Amount in List
        public List<Form1099OIDTaxExemptInterest> TaxExemptStateCodeAndAmount { get; set; }
        ...
        //Saravanan N - 27th May, 2014 - Property added to maintain FormType. To check radio button InterestIncomeGateway page.
