...
INSERT [dbo].[error_message] ( [error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (  N'Address_BR6',  N'collapseOne-txtCity',  N'City name',   N'PersonalInfo',   N'Address',   N'Error',   N'BR',  N'Invalid City name',   N'City name must have at least three characters. ',   N'/PersonalInfo/Address.html',   N'City name must have at least three characters. ', 0)
