...
:setvar DefaultDataPath "C:\Users\jt907\AppData\Local\Microsoft\VisualStudio\SSDT\v11.0\TAX1040_Master_DB\"
:setvar DefaultLogPath "C:\Users\jt907\AppData\Local\Microsoft\VisualStudio\SSDT\v11.0\TAX1040_Master_DB\"
...
GO
/*
The column [dbo].[address].[lived_in_another_state_from] is being dropped, data loss could occur.

The column [dbo].[address].[lived_in_another_state_to] is being dropped, data loss could occur.
*/
...
GO
/*
The column [dbo].[address_history].[lived_in_another_state_from] is being dropped, data loss could occur.

The column [dbo].[address_history].[lived_in_another_state_to] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[address_history])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping fk_address_earned_income_from_non_lived_state...';


GO
ALTER TABLE [dbo].[address] DROP CONSTRAINT [fk_address_earned_income_from_non_lived_state];


GO
PRINT N'Dropping fK_address_lived_in_another_state...';


GO
ALTER TABLE [dbo].[address] DROP CONSTRAINT [fK_address_lived_in_another_state];


GO
PRINT N'Dropping fk_address_history_earned_income_from_non_lived_state...';


GO
ALTER TABLE [dbo].[address_history] DROP CONSTRAINT [fk_address_history_earned_income_from_non_lived_state];


GO
PRINT N'Dropping fK_address_history_lived_in_another_state...';


GO
ALTER TABLE [dbo].[address_history] DROP CONSTRAINT [fK_address_history_lived_in_another_state];
...
GO
ALTER TABLE [dbo].[address] DROP COLUMN [lived_in_another_state_from], COLUMN [lived_in_another_state_to];


GO
ALTER TABLE [dbo].[address] ALTER COLUMN [city] NVARCHAR (50) NULL;

ALTER TABLE [dbo].[address] ALTER COLUMN [earned_income_from_non_lived_state_id] VARCHAR (10) NULL;

ALTER TABLE [dbo].[address] ALTER COLUMN [foreign_state] NVARCHAR (50) NULL;

ALTER TABLE [dbo].[address] ALTER COLUMN [lived_in_another_state_id] VARCHAR (10) NULL;


GO
PRINT N'Altering [dbo].[address_history]...';


GO
ALTER TABLE [dbo].[address_history] DROP COLUMN [lived_in_another_state_from], COLUMN [lived_in_another_state_to];


GO
ALTER TABLE [dbo].[address_history] ALTER COLUMN [city] NVARCHAR (50) NULL;

ALTER TABLE [dbo].[address_history] ALTER COLUMN [earned_income_from_non_lived_state_id] VARCHAR (10) NULL;

ALTER TABLE [dbo].[address_history] ALTER COLUMN [foreign_state] NVARCHAR (50) NULL;

ALTER TABLE [dbo].[address_history] ALTER COLUMN [lived_in_another_state_id] VARCHAR (10) NULL;


GO
PRINT N'Altering [dbo].[error_message]...';


GO
ALTER TABLE [dbo].[error_message] ALTER COLUMN [field_name] NVARCHAR (MAX) NULL;

ALTER TABLE [dbo].[error_message] ALTER COLUMN [short_error_text] NVARCHAR (MAX) NULL;
...
ALTER TABLE [dbo].[state]
    ADD [is_supporting_state] BIT DEFAULT 0 NULL;
...
GO
PRINT N'Altering [dbo].[usp_address_and_address_history_persist]...';
...
ALTER PROCEDURE [dbo].[usp_address_and_address_history_persist]
...
END
GO
PRINT N'Altering [dbo].[usp_personal_info_get_by_personal_info_id]...';
...
/* Sathish N - 01 April, 2014 is_foreign_address to address_type */
ALTER PROCEDURE [dbo].[usp_personal_info_get_by_personal_info_id]
...
END
GO
PRINT N'Altering [dbo].[usp_user_email_update]...';
...
ALTER PROCEDURE [dbo].[usp_user_email_update]
@user_id BIGINT,
@email NVARCHAR(100)
AS
BEGIN
...
END
GO
PRINT N'Refreshing [dbo].[usp_get_error_message]...';


GO
EXECUTE sp_refreshsqlmodule N'dbo.usp_get_error_message';


GO
PRINT N'Refreshing [dbo].[usp_get_all_state]...';


GO
EXECUTE sp_refreshsqlmodule N'dbo.usp_get_all_state';
