...
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (N'Wages_BR2', N'collapseThree-txtW2SSWages', N'Box 3 Social Security Wages', N'Income', N'Wages',  N'Warning', N'BR', N'Box 3 and Box 7 Social security wages should not be more than $117,000', N'Form W2 from <Employer Name>: Box3 and Box 7 Social Security Wages should not be more than $117,000.', N'/Income/W2.html', N'Form W2 from <Employer Name>: Box3 and Box 7 Social Security Wages should not be more than $117,000.', 0)
