...
-- vivek 07-july-14 vivek added the error message as per the latest spec v 2.4
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (N'Spouse_RF7', N'collapseTwo-radmilitarynotapplicable', N'Military area', N'PersonalInfo', N'Spouse', N'Error', N'RF', N'Select Spouse Military service area.', N'You have missed to select the Military service area for your Spouse.', N'/PersonalInfo/SpouseInfo.html', N'Missing Military service area', 0)
...
INSERT INTO [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title]) VALUES (N'Payment_RF12', N'Expiration Month', N'Card Expiration Month', N'File', N'Payment', N'Error', N'RF', N'Missing  Card Expiration Month', N'Missing Card Expiration Month', NULL, NULL)
--22Aug2014 Sathish added error message for expiry year
INSERT INTO [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title]) VALUES (N'Payment_RF14', N'Expiration Year', N'Card Expiration Year', N'File', N'Payment', N'Error', N'RF', N'Missing  Card Expiration year', N'Missing Card Expiration year', NULL, NULL)
