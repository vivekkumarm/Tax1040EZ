...
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title]) VALUES (N'TaxesAndWrapUp_ER2', N'chkAlternateMinimumTaxes', N'Taxpayer not to Incur any AMT & Other taxes', N'TaxesAndWrapUp', N'TaxesAndWrapUp', N'Error', N'ER', N'You should not be subjected to Alternative minimum taxes','You should not  be subjected to  Alternative minimum taxes', N'/TaxesAndWrapUp/taxesandwrapupchecklist.html', NULL)
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title]) VALUES (N'TaxesAndWrapUp_ER3', N'chkMedicareTaxes', N'Additional Social security and Medicare', N'TaxesAndWrapUp', N'TaxesAndWrapUp', N'Error', N'ER', N'You should not be subjected to any additional taxes on social security and Medicare', N'You should not be subjected to any additional taxes on social security and Medicare', N'/TaxesAndWrapUp/taxesandwrapupchecklist.html', NULL)
...
INSERT INTO [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title]) VALUES (N'Filing_V6', N'Filing date', N'Filing Date', N'File', N'Filing', N'Error', N'V', N'Your Filing date must be either current date or future date', N'Your Filing date must be either current date or future date', NULL, NULL)
...
INSERT INTO [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title]) VALUES (N'Filing_V15', N'Filing date', N'Filing Date', N'File', N'Filing', N'Error', N'V', N'Your Filing date must be either current date or future date', N'Your Filing date must be either current date or future date', NULL, NULL)
INSERT INTO [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title]) VALUES (N'Filing_V16', N'Filing date', N'Filing Date', N'File', N'Filing', N'Error', N'V', N'Your Filing date must be either current date or future date', N'Your Filing date must be either current date or future date', NULL, NULL)
