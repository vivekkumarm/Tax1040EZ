...
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (N'Spouse_V10', N'collapseOne-txtSSN', N'Social security number', N'PersonalInfo', N'Spouse', N'Error', N'V', N'Your SSN and Spouse SSN should not be same.', N'Spouse Social Security Number and Taxpayer Social Security Number should not be same.', N'/PersonalInfo/SpouseInfo.html', N'Taxpayer SSN and Spouse SSN should not be same.', 0)
...
-- Bala Removed error messages based on the spec updation(V2.6) for Personal Section
