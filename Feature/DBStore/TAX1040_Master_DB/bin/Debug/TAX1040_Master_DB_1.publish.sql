...
INSERT [dbo].[email_template] ([template_Content], [template_Name], [is_active]) 
              VALUES ( N'<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
                                            ...
                                            <tr>
                                                ...
                                                <td width="38">&nbsp;</td></tr>
                                                          ...
                                                          <tr>
                                                            <td width="38">&nbsp;</td>
                                                            <td width="514">
     <table width="512" border="0" cellspacing="0" cellpadding="0" style="border: solid 1px #5e9826;" align="center">
                                                                    <tr>
                                                                        <td style="font: 12px/20px Arial, Helvetica, sans-serif; padding-bottom: 5px; background: #f8fff4; vertical-align: top; color: #737272; padding: 5px; border-bottom:1px solid #5e9826;">Service</td>     <td style="font: 12px Arial, Helvetica, sans-serif; color: #737272; padding-bottom: 8px; padding-top: 8px; background: #f8fff4; border-bottom:1px solid #5e9826; ">:</td>
    <td style="font: 12px/20px Arial, Helvetica, sans-serif; padding-bottom: 5px;  background: #f8fff4; border-bottom:1px solid #5e9826; vertical-align: top; color: #737272; padding: 5px;">Price</td>
  </tr>
  <tr>
                                                                        <td style="font: 12px/20px Arial, Helvetica, sans-serif; padding-bottom: 5px; vertical-align: top; color: #737272; padding: 5px; border:none;">payment details</td>     <td style="font: 12px Arial, Helvetica, sans-serif; color: #737272; padding-bottom: 8px; padding-top: 8px; ">:</td>
