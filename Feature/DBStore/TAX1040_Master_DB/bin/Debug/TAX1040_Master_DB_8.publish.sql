...
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (N'PrimaryFiler_ER1', N'collapseTwo-dtdateofbirth', N'Taxpayer Date of Birth', N'PersonalInfo', N'PrimaryFiler', N'Error', N'ER', N'Age of Taxpayer must be less than 65 as of January 1, 2014.', N'/PersonalInfo/PrimaryFilerInfo.html', N'Taxpayer age must be under the Age of 65 as of January 1, 2014.', 0)
