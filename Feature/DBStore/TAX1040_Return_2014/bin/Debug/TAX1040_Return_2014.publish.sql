...
CREATE SYNONYM [dbo].[federal_feature_sku] FOR TempMaster.[dbo].[federal_feature_sku]
CREATE SYNONYM [dbo].[state_feature_sku] FOR TempMaster.[dbo].[state_feature_sku]
CREATE SYNONYM [dbo].[feature] FOR TempMaster.[dbo].[feature]
GO
