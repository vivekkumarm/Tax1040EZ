    ...
    public class PaymentRepository : IPaymentRepository
    {
        ...
        public System.Tuple<double, IRS> GetIRSPaymentOption(UserDTO userDTO)
        {
            ...
            try
            {
                ...
                irsPaymentOption = new System.Tuple<double, IRS>(totalTaxOweAmount, ((taxObject.Settlement != null
                                                           && taxObject.Settlement.IRS != null) ? taxObject.Settlement.IRS : null));
            }
            catch (Exception ex)
            {
                ExceptionHandling.LogException(userDTO.UserId, "Class:PaymentRepository,Method Name:GetIRSPaymentOption", ex);
            }
