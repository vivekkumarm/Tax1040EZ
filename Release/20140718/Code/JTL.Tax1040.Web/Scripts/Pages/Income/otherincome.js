...
$(document).ready(function () {
    ...
    $(function () {
        $("#popAlaskaTaxPayer").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Alaska Dividend?</h5>This is the Permanent Dividend Fund paid directly by the Alaska State Government to you. <br/>This is a taxable income under the Federal Government but is non-taxable under the State. Form 1099-MISC is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popAlaskaSpouse").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Alaska Dividend?</h5>This is the Permanent Dividend Fund paid directly by the Alaska State Government to your Spouse. <br/>This is a taxable income under the Federal Government but is non-taxable under the State. <br/>Form 1099-MISC is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popTaxPayerNetBenefitSSB").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Net Benefit Paid?</h5>This is the net benefits you received.<br/> Box 5 of Form SSA-1099 is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#popSpouseNetBenefitSSB").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Net Benefit paid?</h5>This is the net benefit your Spouse received for the year. <br/>This amount is derived by subtracting the figure in box 4 from the figure in box 3. <br/>Box 5 of Form SSA-1099 is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#popTaxPayerFederalTaxSSB").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Voluntary Federal Tax withheld?</h5>This is the total amount of Federal Income Tax that is withheld from your benefits. <br/>Voluntary withholding is applicable only for Federal taxes and not applicable for State or Local Taxes. <br/>Box 6 of Form SSA-1099 is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#popSpouseFederalTaxSSB").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Voluntary Federal Tax withheld?</h5>This is the total amount of Federal Income Tax that is withheld from your Spouse's benefits. <br/>Voluntary withholding is only for Federal taxes and not applicable for State or Local Taxes.<br/> Box 6 of Form SSA-1099 is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#popTaxPayerBenefitsRRB").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is the Net Benefit paid?</h5>This is the net benefit you received for the year. <br/>This amount is derived by subtracting the figure in box 4 from the figure in box 3. <br/>Box 5 of Form SSA-1099 is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#popSpouseBenefitsRRB").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Net Benefits paid?</h5>This is the net benefits your Spouse received under the Railroad Retirement Benefits Scheme.<br/> Box 5 of Form 1099 RRB is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        ...
        $("#popSpouseFederalRRB").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Federal Tax withheld?</h5>This is the total amount of Federal Income Tax withheld from your Spouse's Railroad Retirement Benefit.<br/> Box 10 of Form 1099 RRB is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
