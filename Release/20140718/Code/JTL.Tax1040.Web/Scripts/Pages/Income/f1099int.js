...
function setPopup() {
    SetPopupForControl('popInterestIncome', 'What is Interest Income?', 'The money you made from an interest bearing account is your Interest Income.<br/> This Interest Income is reported in Box 1 of your Form 1099-INT.');

    SetPopupForControl('popEarlyWithdrawalPenalty', 'What is Early Withdrawal Penalty?', 'This is the amount of interest or principal forfeited because of an early withdrawal you make from a certificate of deposit. <br/>This penalty is reported in Box 2 of your Form 1099-INT.');

    SetPopupForControl('popUSSavingBonds', 'Are US Treasury Bonds and Savings Bonds Taxable?', 'Your Interest on US Treasury obligation and Savings Bonds are taxable on your Federal return, but are tax-free at State level.<br/> This interest amount is reported in Box 3 of your Form 1099-INT.');

    SetPopupForControl('popFederalTaxWitheld', 'What is Federal Tax Withheld?', 'This is the total amount of Federal Tax withheld from your wages.<br/> This withholding is reported in Box 4 of Form 1099-INT.');

    SetPopupForControl('popInvestmentExpenses', 'What is Investment Expenses?', 'This is an amount of Interest you paid for your share of investment expenses of a single-class REMIC.<br/> Your share of expenses of a REMIC that may be deductible on Schedule A is subjected to the 2% limit. <br/>Your Investment Expense is reported in Box 5 of Form 1099-INT.');
    ...
    SetPopupForControl('popExemptInterest', 'What is Tax Exempt Interest?', 'This is the amount of interest income that is not subjected to Federal Income Tax.<br/> This Interest amount is reported in Box 8 of Form 1099-INT.');

    SetPopupForControl('popSpecifiedPrivateActivity', 'What is Specified Private Interest?', 'This is the portion of tax-exempt interest earned from private activity bonds.<br/> Refer Box 9 of your Form 1099-INT to know your Specified Private Interest amount.');
    ...
    SetPopupForControl('popExempt', ' What is State Exempt amount?', 'It is an exempt interest amount that you receive from your resident State municipal bonds or mutual funds.<br/> This interest amount is relieved from your State tax return.');

    SetPopupForControl('popStateInfoOnForm1099INT', 'Where to find  Payer State Identification Number?', 'Your Payers State Identification Number is available in Box-14 of your Form 1099-INT.</br><b>What is  State Tax withheld?</b></br>It is nothing but the amount of State Income Tax that has been withheld from you interest income. Some States follow variable income tax rate, while some go with flat rate.<br/> Your State Tax Withholding is reported in Box 15 of Form 1099-INT.');
}

//Saravanan N - 4th June, 2014 - Common method created.
function SetPopupForControl(controlToSetPopup, headerText, bodyText) {
    $('#' + controlToSetPopup).popover({ title: '', content: "<h5>" + headerText + "</h5>" + bodyText + "<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
}
