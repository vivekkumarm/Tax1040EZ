$(document).ready(function () {
    ...
    $(function () {
        $("#popUserName").popover({ title: '', content: "<h5>What is a Tax Garden Username?</h5>It's how we address you and identify your account.<br/><br/> You might have chosen to use your Email Address as you Username.<br /><a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
});
