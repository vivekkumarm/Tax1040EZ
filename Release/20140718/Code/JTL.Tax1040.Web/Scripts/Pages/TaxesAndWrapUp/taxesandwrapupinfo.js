...
$(document).ready(function () {
    ...
    NumbersOnly('txtPersonalIdentificationNumber');
...
//);
    ...
    $(function () {
        $("#DateFiledForExtension").popover({ title: '', content: "<h5>What is 'Date Filed for Extension'?</h5>This is the date on which you filed the Form 4868 automatic extension for Federal Individual income tax return.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#FederalExtensionAmount").popover({ title: '', content: "<h5>What is Federal Extension Amount?</h5>This is the estimated amount of total tax liability that you paid and reported on line 4 of Form 4868.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#DatePaid").popover({ title: '', content: "<h5>What is 'Date Paid'?</h5>This is the date on which you paid your estimated total tax liability, which is reported on line 4 of Form 4868.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#DateOfFiling").popover({ title: '', content: "<h5>What is your filing Date?</h5>If you are filing your tax return after the due date (04/15/2015), you have to select the expected date on which you will  like to file your tax return. <br/>Interest & penalty amount for unpaid tax due will be calculated with this filing date.     <br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#BankName").popover({ title: '', content: "<h5>Why do we need your Bank Name?</h5>If you want to deposit your tax refunds directly to your Bank Account, we will need your Bank Name to make it happen.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#BankRoutingNumber").popover({ title: '', content: "<h5>Why do we need your Bank Routing Number?</h5>If you want to deposit your tax refunds directly to your Bank Account, we will need your Bank Routing Number to make it happen.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#BankAccountNumber").popover({ title: '', content: "<h5>Why do we need your Bank Account Number?</h5>If you want to deposit your tax refunds directly to your Bank Account, we will need your Bank Account Number to make it happen.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#DesignName").popover({ title: '', content: "<h5>What is 'Designee Name'?</h5> This is the name of the person who you have designated to discuss your return with IRS. <br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#Phoneno").popover({ title: '', content: "<h5>Why is 'Designee's Phone Number'?</h5>This is the Phone Number of the person who you have designated to discuss your return with IRS.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#PersonalIdentificationNumber").popover({ title: '', content: "<h5>What is 'Designee's Personal Identification Number'?</h5>This is the Personal Identification Number of the person who you have designated to discuss your return with IRS.  <br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#Incareof").popover({ title: '', content: "<h5>What does 'In care of' stand here?</h5>This is the name of the person who takes care of all your taxation troubles. This might be your attorney, executor, personal assistant.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#PhoneNumber").popover({ title: '', content: "<h5>Which Phone Number do we need?</h5>You can give the daytime phone number of your attorney, executor, personal assistant. <br/>Don't worry! We won't bother them with sales calls!<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
