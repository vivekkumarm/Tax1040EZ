...
$(document).ready(function () {
            ...
            if (data != null) {
                ...
                if (data.Address != null) {
                   ...
                   if (data.Address.HasLivedInMoreThanOneState == true) {
                    ...
                    if (data.Address.LivedInAnotherState != null) // 09Jul2014 Sathsih checked null for  LivedInAnotherState
                        $("#ddlMoreThanOneState").val(data.Address.LivedInAnotherState.StateId);
                    ...
                    $("#dtToDate").val($.datepicker.formatDate('mm/dd/yy', new Date(data.Address.LivedInAnotherStateTo)));
                        ...
                        $("#dtToDate").val('');
                    if (data.Address.EarnedIncomeFromNonLivedState != null) // 09Jul2014 Sathsih  checked null reference
                        $("#ddlEarnedIncomeStateNotLived").val(data.Address.EarnedIncomeFromNonLivedState.StateId);
    ...
    $(function () {
        ...
        $("#popStreetAddress").popover({ title: '', content: "<h5>Why do we need your Street Name?</h5>Your Street Name is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS and States by filling in your Street Name appropriately.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popApartmentNumber").popover({ title: '', content: "<h5>Why do we need your Apartment Number?</h5>Your Apartment Number is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS by filling in your Apartment Number appropriately.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popCity").popover({ title: '', content: "<h5>Why do we need your City Name?</h5>Your City Name is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS and States by filling in your City Name appropriately.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popState").popover({ title: '', content: "<h5>Why do we need your State?</h5>Your State is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS and States by filling in your State appropriately.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popZipCode").popover({ title: '', content: "<h5>Why do we need your Zip Code?</h5>Your Zip Code is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS and States by filling in your Zip Code appropriately.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popPhoneNumber").popover({ title: '', content: "<h5>Why do we need your Phone Number?</h5>We can certainly understand your privacy concern! <br />It is just another information required to fill in your tax return to the IRS and States. <br />We of course know you don't want any sales calls!<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        
    //Changed by Yogalakshmi on 13th May 2014
        $("#popStateorprovince").popover({ title: '', content: "<h5>Why do we need to know the Foreign State or Province?</h5>Your Foreign State or Province is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS and States by filling in your Foreign State or Province appropriately.<br />Make sure to receive all mail correspondence from the IRS and States by filling in your Foreign State or Province appropriately.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popCountryName").popover({ title: '', content: "<h5>Why do we need to know the Foreign Country?</h5>Your Foreign Country is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS and States by filling in your Foreign Country appropriately.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popPostalCode").popover({ title: '', content: "<h5>Why do we need to know your Foreign Postal Code?</h5>Your Foreign Zip Code or Postal Code is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS by filling in your Foreign Zip Code appropriately.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popForeignPhoneNumber").popover({ title: '', content: "<h5>Why do we need your Phone Number?</h5>We can certainly understand your privacy concern! <br />It is just another information required to fill in your tax return to the IRS and States. <br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popFromDate").popover({ title: '', content: "<h5>What is the 'From Date' that has to be mentioned here?</h5>The exact date from which you started to live in this State during the tax year 2014 must be mentioned. <br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popToDate").popover({ title: '', content: "<h5>What is the 'To Date' that has to be mentioned here?</h5>The exact date until which you lived in this State during the tax year 2014 must be mentioned. <br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        
    //Added by Yogalakshmi on 13th May 2014
        $("#popStateOfResidence").popover({ title: '', content: "<h5>What is your State of Residence?</h5>You are a resident of a State if: <br />(1) It is where you physically reside <br />(2) It is where you are permitted to Vote <br />(3) It is the State that has issued you the Driver's License <br />(4) It is the State where you have your Bank Account maintained <br />Residency rules vary by State, it's best to cross check this with the Department of Revenue.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popMoreThanOneState").popover({ title: '', content: "<h5>What is your Part-year Residential State?</h5>When you relocate from one State to a new State you will often be a Part-year Resident of both the States. <br />This applies if you have moved out of your State of Residence permanently to another State during the tax year.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popEarnedIncomeStateNotLived").popover({ title: '', content: "<h5>What is Non-residential State?</h5>It is the State from which you earned an income but did not live during the tax year.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popForeignStreetAddress").popover({ title: '', content: "<h5>Why do we need to know your Foreign Street Address?</h5>Your Foreign Street Name is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS and States by filling in your Foreign Street Name appropriately.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popForeignApartmentNumber").popover({ title: '', content: "<h5>Why do we need to know your Foreign Apartment Number?</h5>Your Apartment Number is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS and States by filling in your Apartment Number appropriately.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popForeignCity").popover({ title: '', content: "<h5>Why do we need to know the Foreign City or Town?</h5>Your Foreign City or Town is an essential part of your full mailing address. <br />Make sure to receive all mail correspondence from the IRS and States by filling in your Foreign City or Town Name appropriately .<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
