...
namespace JTL.Tax1040.BusinessLogic.Test
{
    ...
    public class IT_UnemploymentRepository
    {
        ...
        [TestMethod()]
        public void BusinessRule1Check()
        {

            Form1099G form1099G = new Form1099G()
            {
                //Field 10
                FederalTaxWithHoldingAmount = 100.00,
                //Field 9
                UnEmploymentCompensation = 1000.00
            };
            // Persist
            PersistForm1099G();
        ...
        //Added by Prasanna on 02 July 2014
        [TestMethod()]
        public void BusinessRule2Check()
        {
            Form1099StateInformation form1099StateInformation = new Form1099StateInformation()
            {

                //Field 14
                StateTaxWithholdingAmount = 100.00
            };
            // Persist
            PersistForm1099G();
        ...
        //Added by Prasanna on 02 July 2014
        [TestMethod()]
        public void EligibilityRuleCheck()
        {
            Form1099G form1099G = new Form1099G()
           {
