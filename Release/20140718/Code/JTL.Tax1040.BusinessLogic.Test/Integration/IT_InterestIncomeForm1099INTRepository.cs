...
namespace JTL.Tax1040.BusinessLogic.Test
{
    ...
    public class IT_InterestIncomeForm1099INTRepository
    {
        ...
        public void PersistForm1099INTData()
        {
            ...
            taxReturnData.TaxData = JsonConvert.SerializeObject(form1099INT1);
            taxReturnData.UserDataId = userDataId;

            userData.userId = userId;
            userData.TaxReturnData = taxReturnData;
            ...
            var userDataId1 = mInterestIncomeRepository.PersistTaxReturnForm1099INTData(JsonConvert.SerializeObject(userData));
