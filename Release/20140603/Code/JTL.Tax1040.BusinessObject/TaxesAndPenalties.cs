 ...
 * 27May2014 Sathish Added Federal Extensiton filed date
 */
using System;
...
namespace JTL.Tax1040.BusinessObject
{
    public class TaxesAndPenalties
    {
        ...
        public DateTime? FederalExtensionFiledDate { get; set; }
        ...
        public List<InterestOnUnpaidDue> InterestOnUnpaidDue { get; set; }
    }
}
