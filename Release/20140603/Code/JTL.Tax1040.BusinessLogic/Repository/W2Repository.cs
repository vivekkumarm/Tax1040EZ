                ...
                if (wages != null)
                {
                                ...
                                wages.Employer.Organization.Address.CompanyAddress != null)
                            {
                                ...
                                if (errorMessage == null)
                                {
                                    ...
                                    if (errorMessage == null)
                                    {
                                        bool isValidZipcodeForState = personalInfoDataService.ValidateZipCodeByStateId(
                                                    ...
                                                    Utilities.ConvertToLong(Utilities.RemoveHiphen(wages.Employer.Organization.Address.CompanyAddress.Zip)));
                                ...
                                if (wages.HasEmployeeAddress == true)
                                {
                                    if (wages.EmployeeAddress != null)
                                    {
                                        ...
                                        if ((!string.IsNullOrEmpty(wages.EmployeeAddress.ZipCode)))
                                        {
                                            ...
                                            {
                                                bool isValidZipcodeForState = personalInfoDataService.ValidateZipCodeByStateId(
                                                      wages.EmployeeAddress.StateId, Utilities.ConvertToLong(Utilities.RemoveHiphen(wages.EmployeeAddress.ZipCode)));
                                ...
                                if (wages.OtherDeductsBenefits != null)
                                {
                                    foreach (var otherDeductsBenefits in wages.OtherDeductsBenefits)
                                    {
                                        ...
                                        {
                                            if (otherDeductsBenefits.W2OtherId == 0 || otherDeductsBenefits.Description == string.Empty)
                                            {
                    ...
                    else if (wages.EmploymentType == EmploymentType.HouseholdEmployeeWages)
                    {
                        if (wages.Employer != null)
                        {
                            ...
                            if (errorMessage == null)
                            {
                                errorMessage = BusinessValidationRepository.AssertIsAlphapetOrNumber(wages.Employer.Organization.Name,
                                  Constants.WAGES_HOUSE_HOLD_EMPLOYER_NAME_VALIDATION, errorMessagesAllFromDB);
                                //Add Error Messages into TaxObject with current Form Id.
                                AddErrorToTaxObjectWithFormId(errorMessageListInTaxObject, w2Id, errorMessage);
                            }
                            ...
                            if (errorMessage == null)
                            {
                                errorMessage = BusinessValidationRepository.AssertIsAlphapetOrNumber(wages.Employer.Organization.Address.CompanyAddress.StreetAddress,
                            ...
                            if (errorMessage == null)
                            {
                                errorMessage = BusinessValidationRepository.AssertIsAlphapetOrNumber(wages.Employer.Organization.Address.CompanyAddress.City,
                                  Constants.WAGES_HOUSE_HOLD_CITY_VALIDATION, errorMessagesAllFromDB);
                                //Add Error Messages into TaxObject with current Form Id.
                                AddErrorToTaxObjectWithFormId(errorMessageListInTaxObject, w2Id, errorMessage);
                            }
