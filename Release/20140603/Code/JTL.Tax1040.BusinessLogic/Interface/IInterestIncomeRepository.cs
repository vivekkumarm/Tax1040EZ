...
namespace JTL.Tax1040.BusinessLogic
{
    ...
    public interface IInterestIncomeRepository
    {
        ...
        /// </summary>
        /// <returns></returns>
        System.Tuple<Form1099INT, FilingStatus> GetTaxReturn1099INTData(UserDTO userDTO);
        ...
        /// <param name="userDTO"></param>
        /// <returns></returns>
        System.Tuple<Form1099OID, FilingStatus> GetTaxReturn1099OIDData(UserDTO userDTO);
