...
//29May2014 Sathish Added the method to validate control to accept only letter and space only
function LettersAndSpaceOnly(cntrl) {
    //Prevent key press event
    $('#' + cntrl).keydown(function (e) {
        if (e.shiftKey || e.ctrlKey || e.altKey) {
            e.preventDefault();
            ...
            var key = e.keyCode;
            if (!((key == 8) || (key == 9) || (key == 13) || (key == 45) || (key == 32) || (key == 46) || (key >= 35 && key <= 40) || (key >= 65 && key <= 90))
                || (key >= 96 && key <= 105) // Number pad Numbers only
                ) {
                e.preventDefault();
            }
...
//29May2014 Vivek Added the method to validate control to accept only letter,White space,numbers and # symbols
function NumbersLettersAndHyphen(cntrl) {
    ...
    $('#' + cntrl).keydown(function (e) {
        if (e.shiftKey || e.ctrlKey || e.altKey) {
            ...
            var key = e.keyCode;
            if (!((key == 8) || (key == 9) || (key == 13) || (key == 32) || (key == 32) || (key >= 33 && key <= 44) || (key >= 46 && key <= 47) || (key >= 33 && key <= 47) || (key >= 35) || (key >= 65 && key <= 90))
                      || (key >= 96 && key <= 105) // Number pad Numbers only
                      ) {
                e.preventDefault();
            }
...
////30 May 2014 Vivek Added the method to validate double 
//function NumbersLetterAndUnderscore(cntrl) {
//    //Prevent key press event
//    $('#' + cntrl).keydown(function (e) {
//        var list=[];
//        var key = e.keyCode;
//        list.push(key);
//        if (!((key == 8) || (key == 9) || (key == 13) || (key == 32) ||!(list[0] && key==95)|| (key == 32) || (key >= 33 && key <= 44) || (key >= 46 && key <= 47) || (key >= 33 && key <= 47) || (key >= 35) || (key >= 65 && key <= 90))
//                      || (key >= 96 && key <= 105) // Number pad Numbers only
//                      ) {
//            e.preventDefault();
//        }
...
function extractNumber(obj, e, decimalPlaces, allowNegative) {
    var temp = obj.value;
