/*
    ...
    File Name       :   EICWorksheetPDFBinding.cs 
    Description     :   EICWorksheetPDFBinding PDFBinding Method.
    Author          :   Vincent 
...
{
     public class EICWorksheetPDFBinding
    {
         #region EICWorksheetPage1Binding
         public byte[] EICWorksheetPage1Binding(BusinessObject.Tax1040 tax1040Object)
         {
             var pdfReader = new PdfReader(PDFTemplates.EICWorkSheetOutputForm);
             using (var memoryStream = new MemoryStream())
             {
                 ...
                 XElement mappingXelements = XElement.Load(Assembly.GetExecutingAssembly().GetManifestResourceStream("JTL.Tax1040.PDFBinding.PdfXmlMappers.EICWorkSheetPdfSchema.xml"));
                 ...
                 byte[] EICWorksheetPage1 = memoryStream.GetBuffer();
                 return EICWorksheetPage1;
