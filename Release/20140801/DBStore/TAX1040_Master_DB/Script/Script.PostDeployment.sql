...
-- vivek 07-july-14 vivek added the error message as per the latest spec v 2.4
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (N'Spouse_RF7', N'collapseTwo-chkservedinMilitary', N'Military area', N'PersonalInfo', N'Spouse', N'Error', N'RF', N'Missing Military service area', N'You have missed out to select the Military service area', N'/PersonalInfo/SpouseInfo.html', N'Missing Military service area', 0)
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (N'Spouse_RF8', N'collapseTwo-dtdatedeployed',  N'Date deployed', N'PersonalInfo', N'Spouse', N'Error', N'RF', N'Missing deployment date', N'You have missed out to select the deployment date.', N'/PersonalInfo/SpouseInfo.html', N'Missing deployment date', 0)
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (N'Spouse_V9', N'collapseTwo-dtdatedeployed', N'Date deployed', N'PersonalInfo', N'Spouse', N'Error', N'V', N'Your  Spouse year of birth should not be greater than tax year', N'Your  Spouse year of birth should not be greater than tax year', N'/PersonalInfo/SpouseInfo.html', N'You have entered an Incorrect date. Please enter a valid date', 0)
...
-- Changed the field name collapseTwo-ddlStateOfResidence by vincent on 31 July 2014
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description],[tab], [topic], [error_type], [message_type], [short_error_text],  [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (N'Address_V13', N'collapseTwo-ddlStateOfResidence', N'2014 resident name', N'PersonalInfo', N'Address', N'Error', N'V', N'Your Resident State name and Non resident state name should not be same.', N'Your Resident State name and Non resident state name should not be same.', N'/PersonalInfo/Address.html', N'Your Resident State name and Non resident state name should not be same.', 0)
...
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_BR3','collapseOne-chkHasValidSSN','EIC -  Invalid SSN','Credits','EarnedIncomeCredit','Information','BR','You & Your Spouse must have Valid Social Security Number.','You & Your Spouse must have Valid Social Security Number.','','/Credits/earnedincomecredits.html')
...
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_RF6','collapseTwo-txtNoOfDaysTaxPayerLivedInUS','The Number of Days during 2014 that Taxpayer lived in the United States.','Credits','EarnedIncomeCredit','Error','RF','Number of Days lived in United States for Taxpayer is Missing','Number of Days lived in United States for Taxpayer is Missing',null,'/Credits/earnedincomecredits.html')
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_RF7','collapseTwo-txtNoOfDaysSpouseLivedInUS','The Number of Days during 2014 that  Spouse lived in the United States.','Credits','EarnedIncomeCredit','Error','RF','Number of Days lived in United States for Spouse is Missing','Number of Days lived in United States for Spouse is Missing',null,'/Credits/earnedincomecredits.html')
/*01Jul2014 Sathish Corrrected error message for navigation from summary */
