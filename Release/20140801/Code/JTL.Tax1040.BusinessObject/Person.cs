 ...
 * 4-july-14 vivek Added new property for a check box which was added in the latest spec 2.3
 */
...
namespace JTL.Tax1040.BusinessObject
{
    ...
    public class Person
    {
        ...
        //vivek - 4-july-14 Added new property for a check box which was added in the latest spec 2.3
        public bool? IsMilitary { get; set; }

        //vivek - 4-july-14 Added new property for a check box as a enum which was added in the latest spec 2.3
        public ServedInMilitary ServedInMilitary { get; set; }

        //vivek - 4-july-14 Added new property for the Date Of Deployed as per the latest spec 2.3
        public DateTime? DateOfDeployed { get; set; }
