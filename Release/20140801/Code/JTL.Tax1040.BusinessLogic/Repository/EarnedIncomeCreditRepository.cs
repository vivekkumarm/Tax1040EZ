...
namespace JTL.Tax1040.BusinessLogic
{
    ...
    public class EarnedIncomeCreditRepository : IEarnedIncomeCreditRepository
    {
        ...
        public Tuple<EIC, string, bool, IEnumerable<ErrorMessage>,long> GetEarnedIncomeCredit(UserDTO userDTO)
        {
            try
            {
                ...
                if (((filingStatus == FilingStatus.Single && annualGrossIncome <= Constants.EIC_SINGLE_ADJUSTED_GROSS_INCOME
                    ...
                    ((filingStatus == FilingStatus.Single && !Utilities.IsValidITIN(primaryTaxPayerSSN)) || 
                    (filingStatus == FilingStatus.MarriedFilingJointly && !Utilities.IsValidITIN(spouseSSN))))
                {
                    isEicEligible = true;
                }
                else
                ...
                return new Tuple<EIC, string, bool, IEnumerable<ErrorMessage>, long>(((taxObject != null && taxObject.Credits != null && taxObject.Credits.EIC != null) ? taxObject.Credits.EIC : null), taxPayerName, isEicEligible, taxObjectErrorList, userDTO.UserDataId);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public long PersitEarnedIncomeCredit(long userId, TaxReturnData taxReturnData, int year)
        {
            ...
            try
            {
                ...
                if (eic != null)
                {
                    ...
                    BusinessValidation(taxObject.Credits.EIC, taxObject.ErrorMessages, errorMessages, year);
        ...
        public void BusinessValidation(EIC eic, List<ErrorMessage> errorMessageList,
           ErrorMessages errorMessages, int year)
        {
            ...
            if (eic != null)
            {
                ...
                if (eic.HasReceivedIRSNoticeOnFiling8862 == true && eic.HasEICForPriorYearDisallowance != null && eic.HasEICForPriorYearDisallowance == true)
                {
                  ...
                  BusinessValidationRepository.AssertIsNotNull(eic.NumberOfDaysTaxPayerLivedInUS,
                    ...
                    {
                        errorMessage =
                      BusinessValidationRepository.AssertIsGreater(Utilities.ConvertToDouble(eic.NumberOfDaysTaxPayerLivedInUS), noOfDaysInTaxYear,
                 ...
                 BusinessValidationRepository.AssertIsNotNull(eic.NumberOfDaysSpouseLivedInUS,
                    ...
                    {
                        errorMessage =
                    BusinessValidationRepository.AssertIsGreater(Utilities.ConvertToDouble(eic.NumberOfDaysSpouseLivedInUS), noOfDaysInTaxYear,
