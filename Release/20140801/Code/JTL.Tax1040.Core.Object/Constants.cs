...
namespace JTL.Tax1040.Core.Object
{
    public sealed class Constants
    {
       ...
       //Vincent - 8/7/14- Added a new constant for served in military for Spouse
        ...
        public const string TOPIC_EFILE = "Efile";
      ...
      //  public const string PAYMENT_REQUIRED_EXPIRATION_DATE = "Payment_V9";
        ...
        public const string EFILE_IRS_PAYEMENT_OPTION_NULL = "Efile_RF10";
        public const string EFILE_REQUIRED_PERSONAL_IDENTIFICATION_NUMBER = "Efile_RF11";
        public const string EFILE_REQUIRED_TYPE_OF_ACCOUNT = "Efile_RF1";
        public const string EFILE_REQUIRED_ACCOUNT_NUMBER = "Efile_RF2";
        public const string EFILE_REQUIRED_ROUTING_NUMBER = "Efile_RF3";
        public const string EFILE_REQUIRED_BANK_NAME = "Efile_RF4";
        public const string EFILE_REQUIRED_INSTRUCTION_DIRECT_DEBIT = "Efile_RF5";
        public const string EFILE_REQUIRED_INSTRUCTION_EFTPS = "Efile_RF6";
        public const string EFILE_REQUIRED_INSTRUCTION_CHECK_OR_MONEY_ORDER = "Efile_RF7";
        public const string EFILE_ROUTING_NUMBER_VALIDATION = "Efile_V1";

        //11July2014 Vincent Added a Constant value for Today Date. 
        public const string EFILE_VALIDATION_TODAY_DATE = "Efile_V6";

        //9-july-14 vivek Added by vivek for the efile validation
        public const string EFILE_REQUIRED_EMAIL = "Efile_RF9";
        public const string EFILE_VALIDATION_EMAIL = "Efile_V2";
        public const string EFILE_VALIDATION_PERSONAL_IDENTIFICATION_NUMBER = "Efile_V3";
        public const string EFILE_VALIDATION_IDENTITY_PRODECTION_PIN = "Efile_V4";
        public const string EFILE_VALIDATION_2013PINHASVALUE_AND_SELFSELECTPINDOESNOTHAVEVALUE = "Efile_V5";
        public const string EFILE_VALIDATION_CURRENTDATE = "Efile_V6";
        public const string EFILE_REQUIRED_FILED_MODE = "Efile_RF8";
        public const string EFILE_REQUIRED_PRIMARY_PIN = "Efile_RF12";
        public const string EFILE_REQUIRED_PRIOR_YEAR_AGI = "Efile_RF13";
        public const string EFILE_REQUIRED_PRIOR_IRS_DATE = "Efile_RF14";
        public const string EFILE_REQUIRED_PRIMARY_IPIN = "Efile_RF15";


        //22July2014-Thileep Added Constants for EFILEOPTION 
        public const string EFILE_VALIDATION_SPOUSE_PERSONAL_IDENTIFICATION_NUMBER = "Efile_V7";
        public const string EFILE_VALIDATION_PAYER_PRIORYEAR_PERSONAL_IDENTIFICATION_NUMBER = "Efile_V8";
        public const string EFILE_VALIDATION_SPOUSE_PRIORYEAR_PERSONAL_IDENTIFICATION_NUMBER = "Efile_V9";
        public const string EFILE_VALIDATION_PAYER_EFIN_ISSUEDBYIRS = "Efile_V10";
        public const string EFILE_VALIDATION_SPOUSE_EFIN_ISSUEDBYIRS = "Efile_V11";
        public const string EFILE_VALIDATION_PAYER_EFIN = "Efile_V13";
        public const string EFILE_VALIDATION_SPOUSE_EFIN = "Efile_V14";
        public const string EFILE_VALIDATION_SPOUSE_IDENTITY_PRODECTION_PIN = "Efile_V12";
        public const string EFILE_VALIDATIONTAX_PAYER_TODAY_DATE_ISSUEDBYIRS = "Efile_V15";
        public const string EFILE_VALIDATION_SPOUSE_TODAY_DATE_ISSUEDBYIRS = "Efile_V16";
        public const string EFILE_VALIDATION_PAYER_AGI_PIN_TODAY_DATE = "Efile_V17";
        public const string EFILE_VALIDATION_SPOUSE_AGI_PIN_TODAY_DATE = "Efile_V17";
        public const string EFILE_REQUIRED_PIN_DETAILS = "Efile_RF16";
        public const string EFILE_REQUIRED_FILING_DATE = "Efile_RF17";
