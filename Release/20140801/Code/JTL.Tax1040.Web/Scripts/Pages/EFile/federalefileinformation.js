                ...
                if (data.m_Item2 != null) {
                    if (data.m_Item2.PrimaryTaxPayer != null) {
                        ...
                        if (data.m_Item2.PrimaryTaxPayer.Person != null) {
                            $('#lblTaxpayerName').html(data.m_Item2.PrimaryTaxPayer.Person.FirstName + ' ' + data.m_Item2.PrimaryTaxPayer.Person.LastName);
                            ...
                            $('#lblFirstTimeFillerTaxpayerName').html(data.m_Item2.PrimaryTaxPayer.Person.FirstName + ' ' + data.m_Item2.PrimaryTaxPayer.Person.LastName);
                    ...
                    if (data.m_Item2.Spouse != null) {
                        $('#lblSpouseName').html(data.m_Item2.Spouse.Person.FirstName + ' ' + data.m_Item2.Spouse.Person.LastName);
                        ...
                        $('#lblFirstTimeFillerSpouseName').html(data.m_Item2.Spouse.Person.FirstName + ' ' + data.m_Item2.Spouse.Person.LastName);
                    ...
                    if (data.m_Item3 != null
                        ...
                        if (data.m_Item3.FederalFiling.IRS.IRSTransmission.HavePriorYearPIN) {
                            ...
                            //AGI
                            $('#txtAGITaxpayer').val(data.m_Item3.FederalFiling.IRS.IRSTransmission.PrimaryPriorYearAGI);
                            $('#txtAGISpouse').val(data.m_Item3.FederalFiling.IRS.IRSTransmission.SpousePriorYearAGI);
