...
$(document).ready(function () {
    ...
    $(function () {
        ...
        $("#popFirstName").popover({ title: '', content: "<h5>What is your Spouse's First Name?</h5>First name is your Spouse's given name or personal name.<br/> <br />Your First Name is often used by people during an informal conversation. <br/><br />E.g., if your Spouse's full name is Jane Blake Watts. Jane will be the First Name.<br/><br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popMiddleName").popover({ title: '', content: "<h5>What is your Spouse's Middle Initial?</h5>It's nothing but the first letter of your Spouse's Middle Name.<br/> <br />E.g., if your Spouse's full name is Jane Blake Watts. B from Blake will be the Middle Initial.<br/><br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popLastName").popover({ title: '', content: "<h5>What is your Spouse's Last Name?</h5>Last name is your Spouse's Family Name or Surname. <br/><br />Last Name is often used by people during formal conversation. <br/><br />E.g., if your Spouse's full name is Jane Blake Watts. Watts will be the Last Name.<br/><br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
        ...
        $("#popSSN").popover({ title: '', content: "<h5>Why do we need your Spouse's SSN?</h5>Social Security Number is used to identify their Citizenship or Lawful Alien Status. It is a mandatory information to file your tax return. <br/><br />No worries! We maintain your sensitive information with stringent data security process.<br/><br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
        ...
        $("#popStateCode").popover({ title: '', content: "<h5>State Name</h5>Enter the name of the state where Spouse lived in 2014.<br/><br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
