...
$(document).ready(function () {
    ...
    $(function () {
        $("#popFirstName").popover({ title: '', html: 'true', content: "<h5>What is your First Name?</h5>First name is your given name or personal name.<br /><br />Your First Name is often used by people in an informal situation. <br/><br/>E.g., if your full name is Luke Blake Watts. Luke will be the First Name.<br /><br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popMiddleInitial").popover({ title: '', html: 'true', content: "<h5>What is your Middle Initial? </h5>It's nothing but the first letter of your Middle Name. <br/><br />E.g., if your full name is Luke Blake Watts. B from Blake will be the Middle Initial.<br/><br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popLastName").popover({ title: '', html: 'true', content: "<h5>What is your Last Name? </h5>Last name is your Family Name or Surname. <br/><br/> Your Last Name is often used by people during formal situation. <br/><br/>E.g., if your full name is Luke Blake Watts. <strong>Watts</strong> will be the Last Name.<br/><br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        ...
        $("#popOccupation").popover({ title: '', html: 'true', content: "<h5>How to determine your Occupation?</h5>Tell us what you do for a living and your main source of income. <br/><br />Don't worry, this information doesn't affect your tax returns.<br/><br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        ...
        $("#popSocialSecurityNumber").popover({ title: '', html: 'true', content: "<h5>Why do we need your SSN?</h5>Social Security Number is used to identify your citizenship or Lawful alien Status. It is a mandatory information to file your tax return. <br/><br />No worries! Sensitive information like SSN/ITIN is maintained with strict data protection.<br/><br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        ...
        $("#popDateOfDeploy").popover({ title: '', content: "<h5>Date of Deploy</h5>Select your spouse date of deploy from the date picker icon.<br/><br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
