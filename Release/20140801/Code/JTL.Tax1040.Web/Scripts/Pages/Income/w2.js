...
$(function () {
    ...
    $("#popEmployerID").popover({ title: '', content: "<h5>What is EIN (Employer Identification Number) and where to find it?</h5>EIN is a 9 digit number assigned to your Employer. <br />This can be seen in Line B of your Form W-2 as Employer Identification Number.<br /> <a href='target='_blank' class='more'>Read Common Question</a>" });

    $("#popEmployerName").popover({ title: '', content: "<h5>What is Employer's Name and where to find it?</h5>Name of the organization that you worked for is your Employer's Name. <br />Line C of your Form W-2 is where you can find this.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popEmployerAddress").popover({ title: '', content: "<h5>What is Employer's Address and where to find it?</h5>This is your Employer' physical mailing address. <br />Line C of Form W-2 is where you can pick this from.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popEmployerCity").popover({ title: '', content: "<h5>What is Employer's City and where to find it?</h5>Your Employer's City is a part of their physical mailing address. <br />Line C of Form W-2 is where you can pick this from.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popEmployerState").popover({ title: '', content: "<h5>What is Employer's State and where to find it?</h5>Your Employer's State is a part of their physical mailing address. <br />Line C of Form W-2 is where you can pick this from.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popEmployerZipCode").popover({ title: '', content: "<h5>What is Employer's Zip Code and where to find it?</h5>Your Employer's Zip Code is a part of their physical mailing address. <br />Line C of Form W-2 is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popFederalWages").popover({ title: '', content: "<h5>What is your Federal Wages?</h5>Federal Wages is your taxable wages, salaries, tips and other compensations. <br />Box 1 of Form W-2 is where you can pick this from.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popFederalTaxWithheld").popover({ title: '', content: "<h5>What is Federal Tax Withheld?</h5>This is the total amount of Federal Tax withheld from your wages. <br />Box 2 of Form W-2 is where you can pick this from.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popSocialSecurityWages").popover({ title: '', content: "<h5>What is Social Security Wages?</h5>Box 3 reports the total amount of wages subject to the Social Security tax. The base limit for 2014 Social security wages is $117,000. <br />Box 3 of Form W-2 is where you can pick this from.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popSocialSecurityTaxWithheld").popover({ title: '', content: "<h5>What is Social Security Tax Withholding?</h5>This is the amount of Social Security Tax withheld (6.20% of Social Security Wages) from your wages. <br />Box 4 of Form W-2 is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popMedicalWages").popover({ title: '', content: "<h5>What is Medicare Wages?</h5>The employee's earnings that are subject to a U.S. payroll tax known as the 'Medicare tax.' <br />The amount of Medicare tax calculated on Wages is Medicare wages and this amount is reported in Box 5 of Form W-2.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popMedicalTaxWithheld").popover({ title: '', content: "<h5>What is Medicare Tax Withholding?</h5>Medicare tax is used to fund the Government's Medicare program, which provides subsidized healthcare and hospital insurance benefits to retirees and the disabled. <br />Medicare tax percentage is 1.45%.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popSocialSecurityTips").popover({ title: '', content: "<h5>What is 'Social Security Tips'?</h5>This is total amount of reported tips or commissions subject to Social Security Tax. <br />This amount is reported in Box 7 of Form W-2.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popAllocatedTips").popover({ title: '', content: "<h5>What is Allocated Tips?</h5>The amount tip income allocated to you when you are employed in any food and beverage establishments. <br />Box 8 of Form W-2 is where you can pick this from. <br />This amount is not included in the wages reported in Boxes 1, 3, 5, or 7. <br />Instead, you must add this to your taxable wages on Form 1040 Line 7, and calculate your Social Security and Medicare taxes on this tip income using Form 4137 (PDF).<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popDependentCareBenefits").popover({ title: '', content: "<h5>What is Dependent Care Benefit?</h5>This is the total amount of dependent care benefits that your employer paid to you or incurred on your behalf. <br />Box 10 of Form W-2 is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popNonQualifiedPlan").popover({ title: '', content: "<h5>What is your Non-Qualified Plan payment?</h5>This is the amount you are paid from your employer’s nonqualified deferred compensation or retirement plan.<br/> Box 11 of Form W-2 is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    //Yogalakshmi - 17th July 2014 - Updated Quick help content.
    $("#popProceedWithYourStateAndLocal").popover({ title: 'Quick Help', content: "<h5>State And Local Tax Information</h5><b>Where to find State Identification Number?</b><br />Your Employer's State Identification Number is available in Box-15a of your Form W-2.<br /><b>What is State Wages?</b><br />This is your total wages for the year that is subject to the State Income Tax. <br />If you worked for the same employer in multiple state, there may be multiple lines of information. <br />Box 16 of your W-2 Form is where you can pick this from.<br /><b>Where to find State Tax Withholding?</b><br />The amount of State Income Taxes withheld from your Paychecks. <br />Box 17 of your W-2 Form is where you can pick this from.<br /><b>What is Local Wages?</b><br />This is nothing but your total amount of income that qualifies for local taxation. <br />Box 18 of your W-2 Form is where you can pick this from.<br /><b>What is Local Tax Withholding?</b><br />This the amount of Local Tax (if applicable) that is withheld from your wages. <br />Box 19 of  your Form W-2 is where you can pick this from.<br /><b>What is Locality Name?</b><br />It is the Locality in which your Local Tax Withheld is deducted or  locality that corresponds to the income and taxation reported in Boxes 18 and 19.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });

    
    //Added By Yogalakshmi on 13th May 2014
    
    //Quick Help for W2 benefits and other information 
    $("#popW212A").popover({ title: '', content: "<h5>What are Codes and Amounts in Box 12 and what needs to be done with them?</h5>This contains an amount and a letter code. This area is used to report a variety of benefits and Forms of compensation not captured in Boxes 1-11. <br />The codes in Box 12 of Form W-2 are essential data for tax filing. Some of these codes affect the current year return, while the others are meant for the sake of information. <br />You will have to select the codes that you see in the Box 12 of your W-2 from the drop down Box here. Also, fill in the amount corresponding to the codes selected in the amount box.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#pop12AAmount").popover({ title: '', content: "<h5>What are Codes and Amounts in Box 12 and what needs to be done with them?</h5>This contains an amount and a letter code. This area is used to report a variety of benefits and Forms of compensation not captured in Boxes 1-11. <br />The codes in Box 12 of Form W-2 are essential data for tax filing. Some of these codes affect the current year return, while the others are meant for the sake of information. <br />You will have to select the codes that you see in the Box 12 of your W-2 from the drop down Box here. Also, fill in the amount corresponding to the codes selected in the amount box.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popW212B").popover({ title: '', content: "<h5>What are Codes and Amounts in Box 12 and what needs to be done with them?</h5>This contains an amount and a letter code. This area is used to report a variety of benefits and Forms of compensation not captured in Boxes 1-11. <br />The codes in Box 12 of Form W-2 are essential data for tax filing. Some of these codes affect the current year return, while the others are meant for the sake of information. <br />You will have to select the codes that you see in the Box 12 of your W-2 from the drop down Box here. Also, fill in the amount corresponding to the codes selected in the amount box.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popW212BAmount").popover({ title: '', content: "<h5>What are Codes and Amounts in Box 12 and what needs to be done with them?</h5>This contains an amount and a letter code. This area is used to report a variety of benefits and Forms of compensation not captured in Boxes 1-11. <br />The codes in Box 12 of Form W-2 are essential data for tax filing. Some of these codes affect the current year return, while the others are meant for the sake of information. <br />You will have to select the codes that you see in the Box 12 of your W-2 from the drop down Box here. Also, fill in the amount corresponding to the codes selected in the amount box.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popW212C").popover({ title: '', content: "<h5>What are Codes and Amounts in Box 12 and what needs to be done with them?</h5>This contains an amount and a letter code. This area is used to report a variety of benefits and Forms of compensation not captured in Boxes 1-11. <br />The codes in Box 12 of Form W-2 are essential data for tax filing. Some of these codes affect the current year return, while the others are meant for the sake of information. <br />You will have to select the codes that you see in the Box 12 of your W-2 from the drop down Box here. Also, fill in the amount corresponding to the codes selected in the amount box.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#pop12CAmount").popover({ title: '', content: "<h5>What are Codes and Amounts in Box 12 and what needs to be done with them?</h5>This contains an amount and a letter code. This area is used to report a variety of benefits and Forms of compensation not captured in Boxes 1-11. <br />The codes in Box 12 of Form W-2 are essential data for tax filing. Some of these codes affect the current year return, while the others are meant for the sake of information. <br />You will have to select the codes that you see in the Box 12 of your W-2 from the drop down Box here. Also, fill in the amount corresponding to the codes selected in the amount box.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popW212D").popover({ title: '', content: "<h5>What are Codes and Amounts in Box 12 and what needs to be done with them?</h5>This contains an amount and a letter code. This area is used to report a variety of benefits and Forms of compensation not captured in Boxes 1-11. <br />The codes in Box 12 of Form W-2 are essential data for tax filing. Some of these codes affect the current year return, while the others are meant for the sake of information. <br />You will have to select the codes that you see in the Box 12 of your W-2 from the drop down Box here. Also, fill in the amount corresponding to the codes selected in the amount box.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#pop12DAmount").popover({ title: '', content: "<h5>What are Codes and Amounts in Box 12 and what needs to be done with them?</h5>This contains an amount and a letter code. This area is used to report a variety of benefits and Forms of compensation not captured in Boxes 1-11. <br />The codes in Box 12 of Form W-2 are essential data for tax filing. Some of these codes affect the current year return, while the others are meant for the sake of information. <br />You will have to select the codes that you see in the Box 12 of your W-2 from the drop down Box here. Also, fill in the amount corresponding to the codes selected in the amount box.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    
    //Quick help for Household Employee Wages 
    $("#popHouseholdEmployerName").popover({ title: '', content: "<h5>What is 'Employer's Name'?</h5>Employer name is the name of the person/company who hires you as their Household Employee.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    $("#popHouseholdEmployerAddress").popover({ title: '', content: "<h5>What is Employer's Address?</h5>This is the physical mailing address of the Employer who hires you as their Household Employee.<hr /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    $("#popHouseholdEmployerCity").popover({ title: '', content: "<h5>What is Employer's City?</h5>Name of the city that appears in the mailing address of  your Employer is their City.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    $("#popHouseholdEmployerState").popover({ title: '', content: "<h5>What is Employer's State?</h5>Name of the State that appears in the mailing address of the Employer is their State.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    $("#popHouseholdEmployerZip").popover({ title: '', content: "<h5>What's your Employer's Zip Code?</h5>This is the Zip Code that is found in the physical mailing address of your Employer.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    $("#popHouseholdEmployeeWages").popover({ title: '', content: "<h5>What is 'Household Employee Wages'?</h5>Wages paid to those who work in or around private residence are listed under Household Employee Wages. <br />Note: The Household Employee wages you receive should be less than $1,800 and not reported on Form W-2.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    
    //Quick help for Taxable Scholarship Income
    $("#popInstitutionName").popover({ title: '', content: "<h5>What is 'Institution Name'?</h5>This is the full name of the Institution that gives you scholarship income or fellowship grants.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    $("#popInstitutionAddress").popover({ title: '', content: "<h5>What is the Address of the Institution that gives you Scholarship Income?</h5>The physical mailing address of the Institution is its Address.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    $("#popInstitutionCity").popover({ title: '', content: "<h5>In which city is the Institution that gives you Scholarship Income located?</h5>City that appears on the physical mailing address of the Institution is its City.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    ...
    $("#popInstitutionZip").popover({ title: '', content: "<h5>What is the Zip Code of the Institution that gives you Scholarship Income?</h5>This is the Zip Code seen on the physical mailing address of the Institution that gives scholarship or fellowship grants.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    $("#popTaxableScholarshipAmount").popover({ title: '', content: "<h5>What is Taxable Scholarship Amount?</h5>It's the amount of Scholarship that a student receives from an institution to help pursue studies.  <br />Line 1 of 1040EZ is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    //Quick Help for Employee 
    $("#popEmployeeAddress").popover({ title: '', content: "<h5>What is 'Employee Address'?</h5>Employee Address is nothing but your Street Address. <br />Box F of your W-2 is where you can pick this from.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
    $("#popEmployeeCity").popover({ title: '', content: "<h5>What is 'Employee City'?</h5>This is nothing but your City. <br />Box F of your W-2 is where you can pick this from.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    ...
    $("#popEmployeeZipCode").popover({ title: '', content: "<h5>What is 'Employee Zip Code?</h5>This is nothing but your Zip Code. <br />Box F of your W-2 is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
});
