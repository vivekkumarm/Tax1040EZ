...
$(document).ready(function () {
    ...
    $('#divDataofdeath').hide();
    $('#divStudent').hide();
    $('#chkIsDied').click(function () {
        //if ($('#chkIsDied').prop('checked')) {
        //    $('#divDataofdeath').show();
        //    $('#dtDOD').val('');
        //}
        //else {
    ...
    $("#chkspouselived").change(function () {
        if ($("#chkspouselived").prop('checked'))
            $("#divState").show();
        else {
            $("#divState").hide();
            $("#ddlStateCode").val(0);
...
function GetSpouse() {
    $.ajax({
        ...
        success: function (data, textStatus) {
            ...
            //$("#chknoofabove").prop("checked", data.Spouse.Person.IsOtherInfoNone);
