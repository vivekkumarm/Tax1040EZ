...
namespace JTL.Tax1040.BusinessLogic.Test
{
    ...
    public class IT_InterestIncomeForm1099INTRepository
    {
        ...
        public void PersistForm1099INTData()
        {
            ...
            var userDataId1 = mInterestIncomeRepository.PersistTaxReturnForm1099INTData(userId,taxReturnData);
            ...
            string taxObject = mTaxReturnRepository.GetTaxReturnDatabyUserDataId(userDataId1, userId);
             ...
             var userDataId2 = mInterestIncomeRepository.PersistTaxReturnForm1099INTData(userId, taxReturnData);
            ...
            //Update second Form 1099INT
             ...
             //Persist second Form 1099INT 
             userDataId2 = mInterestIncomeRepository.PersistTaxReturnForm1099INTData(userId, taxReturnData);
        ...
        public static dynamic CreateAndPersistForm1099INT()
        {
            ...
            var userData = mInterestIncomeRepository.PersistTaxReturnForm1099INTData(userId, taxReturnData);
