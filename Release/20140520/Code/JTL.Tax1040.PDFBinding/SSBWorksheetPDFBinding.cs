/*
    ...
    File Name       :   SSBWorksheetPDFBinding.cs 
    Description     :   SSBWorksheetPDFBinding PDFBinding Method.
    Author          :   Vincent 
...
{
    public class SSBWorkSheetPDFBinding
    {
        #region SSBWorksheetPage1Binding
        public byte[] SSBWorksheetPage1Binding(BusinessObject.Tax1040 tax1040Object)
        {
            var pdfReader = new PdfReader(PDFTemplates.SSBWorkSheetOutputForm);
            using (var memoryStream = new MemoryStream())
            {
                ...
                XElement mappingXelements = XElement.Load(Assembly.GetExecutingAssembly().GetManifestResourceStream("JTL.Tax1040.PDFBinding.PdfXmlMappers.SSBWorkSheetPdfSchema.xml"));
                ...
                byte[]  SSBWorksheetPage1 = memoryStream.GetBuffer();
                return SSBWorksheetPage1;
