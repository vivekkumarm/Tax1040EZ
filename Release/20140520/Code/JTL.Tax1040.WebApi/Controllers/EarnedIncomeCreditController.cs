...
namespace JTL.Tax1040.WebApi.Controllers
{
    ...
    public class EarnedIncomeCreditController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public Tuple<EIC, string, bool> GetEarnedIncomeCredit(dynamic userInputData)
        {
            return earnedIncomeCreditRepository.GetEarnedIncomeCredit(userInputData.UserId.Value, userInputData.UserDataId.Value);
        }
        ...
        [HttpPost]
        public dynamic GetCreditSummary(dynamic userInputData)
        {
            return earnedIncomeCreditRepository.GetCreditSummary(userInputData.UserId.Value, userInputData.UserDataId.Value);
        }
        #endregion
