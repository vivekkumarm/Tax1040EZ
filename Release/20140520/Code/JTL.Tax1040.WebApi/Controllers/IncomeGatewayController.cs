...
namespace JTL.Tax1040.WebApi.Controllers
{
    ...
    public class IncomeGatewayController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public Tuple<bool, bool, bool, bool, string> GetIncomeGatewayData(dynamic userData)
        {
            //Extract UI input value.
            ExtractUserData(userData);

            //Call Repository method and return the value.
            Tuple<bool, bool, bool, bool, string> incomeGatewayData = incomeGatewayRepository.GetIncomeGatewayData(userId, userDataId);
            return new Tuple<bool, bool, bool, bool, string>(incomeGatewayData.Item1, incomeGatewayData.Item2, incomeGatewayData.Item3, incomeGatewayData.Item4, incomeGatewayData.Item5);
        }
