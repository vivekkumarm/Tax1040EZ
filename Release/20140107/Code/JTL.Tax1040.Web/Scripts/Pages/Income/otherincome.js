...
$(document).ready(function () {
    ...
    $(function () {
        $("#popAlaskaTaxPayer").popover({ title: '',html:'true', content: "<h5>TaxPayer</h5>Enter Your Alaska Permanent Fund Dividend Income.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popAlaskaSpouse").popover({ title: '', html: 'true', content: "<h5>Spouse</h5>Enter Your Alaska Permanent Fund Dividend Income.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popTaxPayerNetBenefitSSB").popover({ title: '', html: 'true', content: "<h5>TaxPayer</h5>Enter your Social Security benefits amount reported on your Form SSA-1099.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popSpouseNetBenefitSSB").popover({ title: '', html: 'true', content: "<h5>Spouse</h5>Enter your Social Security benefits amount reported on your Form SSA-1099.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popTaxPayerFederalTaxSSB").popover({ title: '', html: 'true', content: "<h5>TaxPayer</h5>Enter your Federal tax withheld amount reported on your Form SSA- 1099.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popSpouseFederalTaxSSB").popover({ title: '', html: 'true', content: "<h5>Spouse</h5>Enter your Federal tax withheld amount reported on your Form SSA- 1099.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popTaxPayerBenefitsRRB").popover({ title: '', html: 'true', content: "<h5>TaxPayer</h5>Enter your Railroad Retirement benefits amount reported on your Form 1099- RRB.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popSpouseBenefitsRRB").popover({ title: '', html: 'true', content: "<h5>Spouse</h5>Enter your Railroad Retirement benefits amount reported on your Form 1099- RRB.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popTaxPayerFederalRRB").popover({ title: '', html: 'true', content: "<h5>TaxPayer</h5>Enter your Federal tax withheld amount reported on your Form 1099-RRB.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popSpouseFederalRRB").popover({ title: '', html: 'true', content: "<h5>Spouse</h5>Enter your Federal tax withheld amount reported on your Form 1099-RRB.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
