$(document).ready(function () {
    ...
    $(function () {
        $("#popPassworResetCode").popover({ title: '', content: "<h5>Where to find this Secret Code?</h5>We have mailed you the Secret Code. Just copy paste or type it in here to validate your identity.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
});
