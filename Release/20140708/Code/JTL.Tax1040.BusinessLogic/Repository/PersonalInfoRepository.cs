    ...
    public class PersonalInfoRepository : IPersonalInfoRepository
    {
                    ...
                    if (address.AddressType == AddressType.ForeignAddress)
                    {
                        if (address.ForeignAddress != null)
                        {
                            ...
                            if (lstCountry != null)
                            {
                                ...
                                if(address.ForeignAddress.CountryId != 0)
                                    countryCode = lstCountry.Where(country => country.CountryId == address.ForeignAddress.CountryId).FirstOrDefault().CountryCode;
                            }
                        }
                    }
                    else if (address.AddressType == AddressType.PersonalAddress)
                    {
                        if (address.PersonalAddress != null)
                        {
                            ...
                            if (lstState != null)
                            {
                                ...
                                if(address.PersonalAddress.StateId != 0)
                                    stateCode = lstState.Where(states => states.StateId == address.PersonalAddress.StateId).FirstOrDefault().StateCode;
                            }
                                       ...
                                       ErrorMessages errorMessages)
        {
            ...
            if (personalDetails != null && personalDetails.Spouse != null && personalDetails.Spouse.Person != null)
            {
                ...
                if (personalDetails.Spouse.HasLivedInAnotherState.HasValue && personalDetails.Spouse.HasLivedInAnotherState.Value && personalDetails.Spouse.LivedInAnotherStateId == 0)
                {
                ...
                {
                    errorMessage =
                        BusinessValidationRepository.AssertIsNotNull(personalDetails.Spouse.Person.ServedInMilitary,
                                                                          Constants.SPOUSE_HAS_SERVED_IN_MILITARY,
                                                                          errorMessages);
                    if (errorMessage != null)
                        errorMessageList.Add(errorMessage);
                    ...
                    if (personalDetails.Spouse.Person.ServedInMilitary == ServedInMilitary.OtherCombatZone)
                    {
                        ...
                        errorMessage =
                            BusinessValidationRepository.AssertIsNotNull(personalDetails.Spouse.Person.DateOfDeployed,
                                                                              Constants.SPOUSE_HAS_OTHER_COMBAT_ZONE,
                                                                              errorMessages);
                        if (errorMessage != null)
                            errorMessageList.Add(errorMessage);
                ...
                personalDetails.PrimaryTaxPayer.Person.Address != null)
            {
                ...
                else if (personalDetails.PrimaryTaxPayer.Person.Address.AddressType == AddressType.ForeignAddress)
                {
                    ...
                    errorMessage =
                       BusinessValidationRepository.AssertGreaterThanZero(
                           personalDetails.PrimaryTaxPayer.Person.Address.ForeignAddress.CountryId,
                ...
                if (personalDetails.PrimaryTaxPayer.Person.Address.HasLivedInMoreThanOneState.HasValue && personalDetails.PrimaryTaxPayer.Person.Address.HasLivedInMoreThanOneState.Value)
                {
                    ...
                    if (personalDetails.PrimaryTaxPayer.Person.Address.ResidenceState.StateId != 0 && personalDetails.PrimaryTaxPayer.Person.Address.LivedInAnotherStateId != 0
                       && personalDetails.PrimaryTaxPayer.Person.Address.ResidenceState.StateId == personalDetails.PrimaryTaxPayer.Person.Address.LivedInAnotherStateId)
                    {
                        errorMessage =
                    ...
                    if (personalDetails.PrimaryTaxPayer.Person.Address.ResidenceState.StateId != 0 && personalDetails.PrimaryTaxPayer.Person.Address.EarnedIncomeFromNonLivedStateId != 0
                       && personalDetails.PrimaryTaxPayer.Person.Address.ResidenceState.StateId == personalDetails.PrimaryTaxPayer.Person.Address.EarnedIncomeFromNonLivedStateId)
                    {
                        errorMessage =
                                            BusinessValidationRepository.AssertIsEqualToLongValue(
                                      personalDetails.PrimaryTaxPayer.Person.Address.ResidenceState.StateId, personalDetails.PrimaryTaxPayer.Person.Address.EarnedIncomeFromNonLivedStateId,
                ...
                if (personalDetails.PrimaryTaxPayer.Person.Address.HasEarnedIncomeFromNonLivedState.Value)
                {
                    errorMessage =
                        BusinessValidationRepository.AssertGreaterThanZero(
