...
$(document).ready(function() {
    ...
    $(function() {
        $("#popSecurityAnswer").popover({ title: '', content: "<h5>What if you forget the answer?</h5>Don’t Panic! We can still help you. You can try another way to regain your access or reach the support team.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
        $("#popSecurityQuestions").popover({ title: '', content: "<h5>What is the use of a Security Question?</h5>Hope you remember selecting a Security Question during the sign-up process! You can now use it to validate your identity. Regain access to your Tax Garden account by answering the Security Question.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
});
