...
$(document).ready(function () {
    ...
    $(function () {
        $("#popEmail").popover({ title: '', content: "<h5>Why do we need your Email Address?</h5>This is how we authorize your account and communicate with you. Help us drop in credentials reset mailer, offers and important alerts to the right inbox.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
