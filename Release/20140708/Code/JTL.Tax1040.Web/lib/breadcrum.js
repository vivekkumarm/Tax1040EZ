        ...
        success: function (data, textStatus) {
            if (data != null && data.m_Item1 != null) {
                $.each(data.m_Item1, function (index, value) {
                    ...
                    if (value.Tab == Tab.Credits && value.MessageType == MessageType.RF) {
            ...
            if (data != null && data.m_Item3 != null) {
                ...
                if (personalInfoEligibilityErrorCount > 0) {
                    ...
                    $("#supTaxesWrapUpErrorCount").css("display", "none");
                    $("#supStateErrorCount").css("display", "none");
                    $('#aIncome').attr("href", '../Diagnostics/finaldiagnostics.html?Tab=' + Tab.Income);
                }
                    ...
                    $("#supTaxesWrapUpErrorCount").css("display", "none");
                    $("#supStateErrorCount").css("display", "none");
                    $('#aDeduction').attr("href", '../Diagnostics/finaldiagnostics.html?Tab=' + Tab.Deduction);
                }
                    ...
                    $("#supTaxesWrapUpErrorCount").css("display", "none");
                    $("#supStateErrorCount").css("display", "none");
                    $('#aCredits').attr("href", '../Diagnostics/finaldiagnostics.html?Tab=' + Tab.Credits);
                }
                else if (taxesAndWrapUpEligibilityErrorCount > 0) {
                    $('#aReview').attr('disabled', true);
                    $('#aState').attr('disabled', true);
                    $("#supStateErrorCount").css("display", "none");
                    $('#aTaxesAndWrapUp').attr("href", '../Diagnostics/finaldiagnostics.html?Tab=' + Tab.TaxesAndWrapUp);
                }
                else if (stateDiagnosticsCount > 0) {
                    $('#aReview').attr('disabled', true);
                    $('#aState').attr("href", '../Diagnostics/finaldiagnostics.html?Tab=' + Tab.State);
                }
            }
