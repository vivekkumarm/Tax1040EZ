...
$(document).ready(function () {
    ...
    $('#frmFiledTaxElectronically').validate({
        ...
        messages: {
            ...
            radEfileOption:
               {
                   required: function () {  $('#divradError').html('Missing Prior year PIN Information'); }
               },

            dtFillingDate:
                {
                    required: function () { $('#divFilingTDErrorMsg').html('Missing Filing date'); }
                },
    ...
    $('#frmFirstTimeFiledElectronically').validate({
        ...
        messages:
        {
            ...
            dtFirstTimeFillerSpouseTodaysDate: {
                required: function () { $('#divSpouseFillerErrorMssg').html('Missing Filing date'); }

            },
            dtFirstTimeFillerTaxpayerTodayDate: {
                required: function () { $('#divFillerTDErrorMssg').html('Missing Filing date'); }
            }
        }
    });
            ...
            if (data != null) {
                ...
                if (data.m_Item2 != null) {
                    ...
                    if (data.m_Item3 != null) {
                        ...
                        isEfile = data.m_Item3.FederalFiling.IsEfile;
