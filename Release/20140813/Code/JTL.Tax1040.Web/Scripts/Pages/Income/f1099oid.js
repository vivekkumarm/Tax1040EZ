...
function setPopup() {
    $("#popOriginalIssueDiscount").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is an Original Issue Discount?</h5>When a bond or note is issued at an amount lesser than its face value, the discount thus earned is the Original Issue Discount. <br/><br/>A portion of this discount is annually recognized as taxable interest and is reported in Box 1 of your Form 1099-OID.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popOtherPeriodicalInterest").popover({ title: 'Quick Help', html: 'true', content: "<h5>What are Other Periodical Interest?</h5>This is the other additional Periodical Interest amount that you might have earned during the Tax year 2014. <br/><br/>Box 2 of your Form 1099-OID  is where you can pick this from.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popEarlyWithdrawalPenalty").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Early Withdrawal Penalty?</h5>This is the penalty paid if you had to withdraw the deposited money before the maturity date of the agreement. <br/><br/>This penalty is reported in Box 3 of Form 1099-OID.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popFederalTaxWithheld ").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Federal Tax Withheld?</h5>This is the total amount of Federal Tax withheld from your wages.<br/><br/> Your withholding is reported in Box 4 of Form 1099-OID.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
    ...
    $("#popOIDonUSTreasuryObligation").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is OID on US Treasury Obligation?</h5>OID on a U.S. Treasury Obligation for the part of the year you owned, it is reported as interest income.<br/><br/> Box 8 of Form 1099-OID is where you can pick this from.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popInvestmentExpenses").popover({ title: 'Quick Help', html: 'true', content: "<h5>What are Investment Expenses?</h5>It is nothing but the investment related expenses that can be deducted on Schedule A subject to 2%. <br/><br/>Your Investment Expense is reported in Box 9 of Form 1099-OID.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    ...
    $("#popStateCode3").popover({ title: 'Quick Help', html: 'true', content: "<h5> State Code</h5>Enter Your In State Code on Your OID TaxExempt Interest.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

    $("#popStateExempt").popover({ title: 'Quick Help', html: 'true', content: "<h5> What is State Exempt amount?</h5>It is an exempt interest amount that you receive from your resident State municipal bonds or mutual funds. <br/><br/>This interest amount is relieved from your State tax return.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    ...
    $("#popStateInfoOnForm1099OID").popover({ title: 'Quick Help', html: 'true', content: "<h5>State Information on Form 1099OID</h5><b>Where to find  Payer State Identification Number?</b><br/><br/>Your Payer's State Identification Number is available in Box-11 of your Form 1099-OID.<br/><br/><b>What is State Tax Withheld?</b><br /><br/>It is nothing but the amount of State Income Tax that has been withheld from you interest income.<br/><br/> Some States follow variable income tax rate, while some go with flat rate.<br/><br/> Your State Tax Withholding is reported in Box 12 of Form 1099-OID.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });
}
