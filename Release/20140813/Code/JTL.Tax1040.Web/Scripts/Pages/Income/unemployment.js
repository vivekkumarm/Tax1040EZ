...
function SetTooltip() {
    ...
    $("#popPayerFederalIdentificationNumber").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is Payer's ID No?</h5>It's nothing but your Payer's Federal Identification Number (FIN).<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
