...
namespace JTL.Tax1040.WebApi.Controllers
{
    public class PersonalInfoController : ApiController
    {
        ...
        // Swapnesh added on 1-8-2014 for textbox RF colour
        [HttpPost]
        public Tuple<PrimaryTaxPayer, List<ErrorMessage>> GetPrimaryTaxPayerAndErrorList(UserDTO user)
        {
            return personalInfoRepository.GetPrimaryTaxPayerAndErrorList(user.UserId, user.UserDataId);
        }
        ...
        [HttpPost]
        public System.Tuple<PersonalDetails, List<ErrorMessage>,long> GetPersonalDetailsByUserIdAndUserDataId(dynamic person)
        {
        ...
        /// <summary>
        /// Get Personal Is Enabled Error Count
        /// </summary>
        /// <param name="person"></param>
        /// <returns></returns>
        // 07Aug2014 Sathish  Get Personal Is Enabled Error Count to hide error count in personal left menu
        [HttpPost]
        public PersonalSection GetCurrentPersonalSection(UserDTO userDTO)
        {
            return personalInfoRepository.GetCurrentPersonalSection(userDTO);
        }
