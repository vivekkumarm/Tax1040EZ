   ...
   public interface ITaxesAndWrapUpRepository
    {
       ...
       System.Tuple<TaxesAndPenalties, string, DateTime, IEnumerable<ErrorMessage>> GetTaxAndWrapup(UserDTO userDTO);
       ...
       Tuple<Tax1040EZPage1, List<ErrorMessage>, bool, string, long> GetFederalTaxSummary(UserDTO userDTO);
       ...
       void Genernate1040EZForm(UserDTO userDTO);
    }
}
