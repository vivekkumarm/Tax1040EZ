        ...
        success: function (data, textStatus) {
            ...
            if (data.m_Item1 != null) {
                ...
                //Modified by Thileep on 09.06.2014 for displaying place holder
                    $("#txtTaxableScholarship").val(data.m_Item1.TaxableScholarshipCredit == 0 ? "" : data.m_Item1.TaxableScholarshipCredit);
                    $("#txtPensionAnnuity").val(data.m_Item1.PensionAnnuity == 0 ? "" : data.m_Item1.PensionAnnuity);
                    $("#txtInmateWages").val(data.m_Item1.PenalInstitutionInmateWages == 0 ? "" : data.m_Item1.PenalInstitutionInmateWages);
                    $("#txtNoOfDaysTaxPayerLivedInUS").val(data.m_Item1.NumberOfDaysTaxPayerLivedInUS == 0 ? "" : data.m_Item1.NumberOfDaysTaxPayerLivedInUS);
                    $("#txtNoOfDaysSpouseLivedInUS").val(data.m_Item1.NumberOfDaysSpouseLivedInUS == 0 ? "" : data.m_Item1.NumberOfDaysSpouseLivedInUS);
...
function PersistEIC() {
    ...
    var EIC = {
        ...
        HasEICForPriorYearDisallowance: ($('#radEICforPriorYearDisallowanceYes').prop('checked') == false && $('#radEICforPriorYearDisallowanceNo').prop('checked') == false) ? null : $('#radEICforPriorYearDisallowanceYes').prop('checked'),
        HasIncorrectlyReportedEarnedIncome: ($('#radIncorrectlyReportedEarnedIncomeYes').prop('checked') == false && $('#radIncorrectlyReportedEarnedIncomeNo').prop('checked') == false) ? null : $('#radIncorrectlyReportedEarnedIncomeYes').prop('checked'),
