$(document).ready(function () {
    ...
    $(function () {
        $("#popPassworResetCode").popover({ title: '', content: "<h5>Password Reset Code</h5>Enter the Password reset code that you received in email to reset your password and to access your account.<br /> <a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
});
