...
$(document).ready(function () {
    ...
    //Changed by thileep 06 June 2014
    $("#txtW2StateID0").bind("keyup paste", function () {
        setTimeout(jQuery.proxy(function () {
            this.val(this.val().replace(/[^0-9]/g, ''));
        }, $(this)), 0);
    });
    ...
    //Added by Thileep on 06 June 2014
    $("#txtTaxableScholarshipAmount").bind("keyup paste", function () {
        setTimeout(jQuery.proxy(function () {
            this.val(this.val().replace(/[^0-9.]/g, ''));
        }, $(this)), 0);
    });
    ...
    //Added by Thileep on 06 June 2014
    $("#txtHouseholdEmployeeWages").bind("keyup paste", function () {
        setTimeout(jQuery.proxy(function () {
            this.val(this.val().replace(/[^0-9.]/g, ''));
        }, $(this)), 0);
    });
