/*
    ...
    File Name       :   SSBWorkSheet.cs 
    Description     :   Business object for Form 1040EZ - SSB worksheet 
    Author          :   Ashok kumar 
...
namespace JTL.Tax1040.BusinessObject
{
    public class SSBWorkSheet
    {
        ...
        //public double Line7Amount { get; set; }

        public bool IsLine7SSBTaxable { get; set; }
    }
}
