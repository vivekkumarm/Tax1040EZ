...
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (N'UnemploymentCompensation_ER1', N'collapseTwo-txtRepaidAmountCurrentYear', N'Repaid amount',  N'Income', N'Unemployment Compensation', N'Error', N'ER', N'Repaid Unemployment benefit amount for earlier Year.', N'{0} Repayment of earlier year Unemployment Compensation benefits Should not be deducted on Form 1040EZ.', N'/Income/Unemployment.html', NULL, 0)
...
INSERT [dbo].[error_message] ([error_code], [field_name], [field_description], [tab], [topic], [error_type], [message_type], [short_error_text], [long_error_text], [message_target], [error_title], [is_deleted]) VALUES (N'OtherIncome_ER2', N'collapseOne-txtTaxPayerNetBenefitSSB', N'Taxable Social Security & Railroad Benefits',  N'Income', N'Other Income', N'Error', N'ER', N'Taxable Social Security and Railroad benefits', N' You & your Spouse (if MFJ) should not have any Taxable social security Benefits or Railroad benefits Income on your Tax return.',  N'/Income/OtherIncome.html', NULL, 0)
...
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_RF1','collapseOne-txtTaxableScholarship','EIC _ Taxable of Fellowship Income','Credit','Earned Income Credit','Error','RF','You have missed out the  amount received as taxable Scholarship or Fellowship Income not reported on Form W-2','Missing amount for Taxable Scholarship or Fellowship Income',null,'/Credits/earnedincomecredits.html')
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_RF2','collapseOne-txtPensionAnnuity','EIC - Pension or annuity from a non-qualified deferred compensation ','Credit','Earned Income Credit','Error','RF','You have missed out the amount received as Pension or annuity from a non-qualified deferred compensation plan Income not reported on Form W-2','Missing amount for Pension or annuity from a non-qualified deferred compensation',null,'/Credits/earnedincomecredits.html')
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_RF3','collapseOne-txtInmateWages','EIC -wAges for work done while an inmate in a penal institution','Credit','Earned Income Credit','Error','RF','You have missed out the amount received as wages for work has done while an inmate in a penal institution','Missing amount for wages for work done while an inmate in a penal institution',null,'/Credits/earnedincomecredits.html')
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_RF4','collapseTwo-radEICforPriorYearDisallowanceYes','EIC _ Taxable of Fellowship Income','Credit','Earned Income Credit','Error','RF','Check that You like to claim Earned Income Credit for Prior year disallowance ','Selection of Prior year disallowance of EIC Missing',null,'/Credits/earnedincomecredits.html')
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_RF5','collapseTwo-radIncorrectlyReportedEarnedIncomeYes','EIC _ Taxable of Fellowship Income','Credit','Earned Income Credit','Error','RF','Check that Your EIC was reduced or disallowed in earlier year is because of Incorrectly reported Income.','Selection of Prior year EIC was reduced or disallowed in earlier year because of Incorrect Income is Missing',null,'/Credits/earnedincomecredits.html')
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_RF6','collapseTwo-txtNoOfDaysTaxPayerLivedInUS','EIC _ Taxable of Fellowship Income','Credit','Earned Income Credit','Error','RF','Number of Days lived in United States for Taxpayer is Missing','Number of Days lived in United States for Taxpayer is Missing',null,'/Credits/earnedincomecredits.html')
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_RF7','collapseTwo-txtNoOfDaysSpouseLivedInUS','EIC _ Taxable of Fellowship Income','Credit','Earned Income Credit','Error','RF','Number of Days lived in United States for Spouse is Missing','Number of Days lived in United States for Spouse is Missing',null,'/Credits/earnedincomecredits.html')
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_BR9','Earned Income Credit was reduced or disallowed due to Math or clerical Error','Earned Income Credit was reduced or disallowed due to Math or clerical Error','Credit','Earned Income Credit','Warning','BR',' The Form 8862 is used to report Earned Income Credit was reduced or disallowed for any reason other than a math or clerical error for a year after 1996  and to claim EIC for the year.','Earned Income Credit was reduced or disallowed for any reason other than a math or clerical error','','')
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_BR10','EIC was reduced or disallowed in the earlier year','EIC was reduced or disallowed in the earlier year was because of Incorrectly reported the  Earned  or Investment Income.','Credit','Earned Income Credit','Warning','BR','The only reason Your EIC was reduced or disallowed in an earlier year was because You incorrectly reported Your Earned Income or Investment Income, You do not complete the rest of this form. You must attach this Form 8862 to Your tax return to take the EIC.',' EIC was reduced or disallowed in an earlier year was because You incorrectly reported Your Earned Income or Investment Income','','')
...
INSERT [dbo].[error_message] ([error_code],[field_name],[field_description],[tab],[topic],[error_type],[message_type],[long_error_text],[short_error_text],[error_title],[message_target])  VALUES('EarnedIncomeCredit_BR12','SP Number of Days during 2014 lived in the United States.','The Number of Days during 2014 that  Spouse lived in the United States.','Credit','Earned Income Credit','Error','BR','Number of Days lived in United States for Spouse is Missing','Number of Days lived in United States for Spouse is Missing','','')
