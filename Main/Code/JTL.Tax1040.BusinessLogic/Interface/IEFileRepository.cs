...
namespace JTL.Tax1040.BusinessLogic
{
    public interface IEFileRepository
    {
        ...
        /// <summary>
        /// Befores the persist IRS tranmission mapping.
        /// </summary>
        /// <param name="userId">The user id.</param>
        /// <param name="taxReturnData">The tax return data.</param>
        /// <returns></returns>
        Tuple<BusinessObject.Tax1040, string, List<ErrorMessage>> PersistIRSTransmissionBeforeEfile(long userId, TaxReturnData taxReturnData);


        /// <summary>
        /// Persists the IRS tranmission efile.
        /// </summary>
        /// <param name="userId">The user id.</param>
        /// <param name="taxObject">The tax object.</param>
        /// <returns></returns>
        long PersistIRSTransmissionEfile(long userId, JTL.Tax1040.BusinessObject.Tax1040 taxObject, EfileErrorCollection efileerrorcollection);
        ...
        /// <returns></returns>
        ///Swapnesh 8/aug/2014
        IEnumerable<ErrorMessage> GetEfileErrorMessage(UserDTO UserData);
        ...
        bool DeleteIRSTransmissionDetail(UserDTO UserData);
