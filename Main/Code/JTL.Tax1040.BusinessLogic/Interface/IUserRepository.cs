...
namespace JTL.Tax1040.BusinessLogic
{
    ...
    public interface IUserRepository
    {
        ...
        Tuple<Dictionary<int, string>, int> GetSecurityQuestion(long userID);
        ...
        System.Tuple<long, StringCollection> UpdateUserDetailsByUserId(User user);
        ...
        /// </summary>        
        /// <returns>Tuple</returns>
        System.Tuple<long, StringCollection> ValidateUserPasswordByUserId(User user);
