...
namespace JTL.Tax1040.BusinessLogic
{
    ...
    public interface IUnemploymentRepository
    {
        ...
        void DeleteAndPersistUnemployment(UserDTO userDTO, Tax1040.BusinessObject.Tax1040 refTaxObject = null);
        ...
        Tuple<Form1099G, string, string, FilingStatus,IEnumerable<ErrorMessage>> GetUnemploymentById(UserDTO userDTO);
        #endregion
    }
}
