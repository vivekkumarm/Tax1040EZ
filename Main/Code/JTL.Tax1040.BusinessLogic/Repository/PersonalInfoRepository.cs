                ...
                if (personalDetails.PrimaryTaxPayer.Person.Address.AddressType == AddressType.PersonalAddress)
                {
                        ...
                        personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State != null)
                    {
                        ...
                        if ((personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId != 52) &&
                            (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId != 53) &&
                            (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId != 54) &&
                            (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId != 55) &&
                            (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId != 56) &&
                            (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId != 57))
                        {
                    ...
                    //Vincent-6 Aug 2014- I have implemented the business rule for required state id 
                    if (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State != null && !Utilities.IsStringEmpty(personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.ZipCode))
                    {
                        if ((personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId == 52) &&
                        ...
                        if (((personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId == 53) ||
                             (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId == 54) ||
                             (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId == 55) ||
                             (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId == 56)) &&
                        ...
                        if ((personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId == 57))
                        {
                        ...
                        if (((personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId == 52) ||
                            ...
                            (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.State.StateId == 57)))
                        {
                            if (!Utilities.IsStringEmpty(personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.City) && !((personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.City.ToUpper() == "APO") ||
                               (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.City.ToUpper() == "DPO") ||
                               (personalDetails.PrimaryTaxPayer.Person.Address.PersonalAddress.City.ToUpper() == "FPO")))
                            {
