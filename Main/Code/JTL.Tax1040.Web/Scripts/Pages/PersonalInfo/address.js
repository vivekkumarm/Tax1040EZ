    ...
    $('#btnAddessContinue').click(function () {
        if (PersistAddress()) {
            ...
            if (stateOfResidence != '---Select---' && stateOfResidence != 'California' && stateOfResidence != 'New York' && stateOfResidence != 'Illinois' && stateOfResidence != 'Michigan' && stateOfResidence != 'Georgia') {
                ...
                stateOfResidence = "";
                window.sessionStorage.setItem("StateOfResidence", "");
            }
            ...
            if (earnedStateNotLived != "") {
                ...
                window.sessionStorage.setItem("EarnedIncomeStateNotLived", "");
            }
            ...
            if (livedStateInfo != "" ) {
                ...
                window.sessionStorage.setItem("MorethanOneState", "");
            }
            ...
            txtForeignPhoneNumber:
                {
                    ...
                    validatePhoneNumber: "Foreign Phone Number is invalid."
                }
        }
