...
function setPopup() {
    $(function () {
        $("#popPayerName").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is 'Payer Name'?</h5>It is the name of the Financial Institution or Bank who pays you the Interest Income.<br/><br/> Fill it in exactly as it appears on your Form 1099-INT.<br/> <a href='' target='_blank' class='more'>Read Common Question</a>" });

        $("#popPayerEIN").popover({ title: 'Quick Help', html: 'true', content: "<h5>What is 'Payer FIN'?</h5>It is the Federal Identification Number (FIN) allotted to the Payer who provides you your interest income.<br/><br/> Fill it in exactly as it appears on your Form 1099-INT.<br/><a href='' target='_blank' class='more'>Read Common Question</a>" });
    });
}
