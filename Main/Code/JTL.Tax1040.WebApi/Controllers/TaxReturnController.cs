 ...
 * 11th Aug,2014 - Thileep Changed GetEligibilityDiagnosticsErrorList To get control focus on EZ Eligibility for Unemployment section
 * 
 */
...
namespace JTL.Tax1040.WebApi.Controllers
{
    ...
    public class TaxReturnController : ApiController
    {
        ...
        public dynamic GetEligibilityDiagnosticsErrorList(dynamic userInputData)
        {
            ...
            long taxandWrapupErrorCount = 0;
            long eicErrorCount = 0;
            ...
            if (tax1040Object != null && tax1040Object.ErrorMessages != null)
            {
                ...
                //vivek 4-Aug-14 for the tax and wrapup error count
                taxandWrapupErrorCount = tax1040Object.ErrorMessages.Where(err => err.ErrorType == Constants.TOPIC_ERROR && err.Topic == Constants.TOPIC_TAX_AND_WRAPUP).Count();

                //vivek 4-Aug-14 for the EIC error count

                eicErrorCount = tax1040Object.ErrorMessages.Where(err => err.ErrorType == Constants.TOPIC_ERROR && err.Topic == Constants.TOPIC_EARNED_INCOME_CREDIT).Count();
                ...
                //12Aug2014 Sathsih changed condition from contains to equals 
                if (taxObjectErrorList != null)
                {
                    taxObjectErrorList.RemoveAll(em => em.Topic.Equals(Constants.TOPIC_FILING));
                }
                tax1040Object.ErrorMessages.RemoveAll((em => em.Topic.Equals(Constants.TOPIC_FILING)));


                // 06Jun2014 Sathish returns elgibility error count for each tab used to disable breadcrum menu
                eligibilityErrorList = tax1040Object.ErrorMessages.FindAll(em => !string.IsNullOrEmpty(em.MessageType) && em.MessageType.Equals(Constants.MESSAGE_TYPE_ER));
                ...
                //Thileep - 11th Aug,2014,Added code To get control focus on EZ Eligibility for Unemployment section
                string messageTargetUnEmployment = "";
                string controlToFocusUnEmployment = "";
                int formIdUnEmployment = 0;
                if ((tax1040Object.Income != null && (tax1040Object.Income.W2Wages == null || (tax1040Object.Income.W2Wages != null && tax1040Object.Income.W2Wages.Count() == 0)) && tax1040Object.Income.Form1099G != null && tax1040Object.Income.Form1099G.Count() > 0))
                {
                    formIdUnEmployment = tax1040Object.Income.Form1099G.Min(x => x.Form1099GId);
                    controlToFocusUnEmployment = "collapseTwo-txtF1099GUnempCompReceived";
                    if (tax1040Object.ErrorMessages.Where(err => err.ErrorCode == Constants.TAX_AND_WRAP_UP_TAXABLE_INCOME).Count() > 0)
                    {
                        messageTargetUnEmployment = "/Income/Unemployment.html";
                        tax1040Object.ErrorMessages.Where(err => err.ErrorCode == Constants.TAX_AND_WRAP_UP_TAXABLE_INCOME).Single().FormId = formIdUnEmployment;
                        tax1040Object.ErrorMessages.Where(err => err.ErrorCode == Constants.TAX_AND_WRAP_UP_TAXABLE_INCOME).Single().FieldName =
                            controlToFocusUnEmployment;
                        tax1040Object.ErrorMessages.Where(err => err.ErrorCode == Constants.TAX_AND_WRAP_UP_TAXABLE_INCOME).Single().MessageTarget =
                            messageTargetUnEmployment;
                    }
                }
            ...
            //vivek 8-Aug-14 passed the EIC and tax and wrapup error count as a tuple
            System.Tuple<long, long> extraErrorCount = new Tuple<long, long>(taxandWrapupErrorCount, eicErrorCount);

            System.Tuple<long, long, long, long, long, long, long, Tuple<long, long>> incomeLeftMenuErrorCount = new System.Tuple<long, long, long, long, long, long, long, Tuple<long, long>>
                                                          (w2errorCount, InterestIncomeerrorcount, OtherIncomeerrorcount, Unemploymenterrorcount
                                                          , primaryFilerCount, spouseErrorCount, addressErrorCount, extraErrorCount);

            if (eligibilityErrorCountBasedOnTab != null && eligibilityErrorCountBasedOnTab.Count == 0)
                eligibilityErrorCountBasedOnTab = null;

            return new System.Tuple<List<ErrorMessage>, List<ErrorMessage>, Dictionary<string, int>, bool, System.Tuple<long, long, long, long, long, long, long, Tuple<long, long>>>(tax1040Object.ErrorMessages,
                                                                                                        taxObjectErrorList,
