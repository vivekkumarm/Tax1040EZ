...
namespace JTL.Tax1040.WebApi.Controllers
{
    public class UserController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPut]
        public Tuple<bool,StringCollection> ResetPassword(User userDetail)
        {
            //TODO : Have to implement code to pass the errorMessages to UI after the Demo.
            StringCollection errormessage;
            var result = userRepository.ResetPassword(userDetail.UserName, userDetail.Password, userDetail.UserId, out errormessage);
            return new Tuple<bool, StringCollection>(result, errormessage);
        }
        ...
        [HttpPost]
        public Tuple<Dictionary<int, string>, int> GetSecurityQuestion(UserDTO user)
        {
            return userRepository.GetSecurityQuestion(user.UserId);
        }
