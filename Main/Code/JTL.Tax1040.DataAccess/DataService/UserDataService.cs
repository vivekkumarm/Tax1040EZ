        ...
        public dynamic PersistUser(User user)
        {
            ...
            using (var sqlConnection = new SqlConnection(mConnectionString))
            {
                using (var sqlCommand = sqlConnection.CreateCommand())
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@security_question_id", user.SecurityQuestionId);
                    sqlCommand.Parameters.AddWithValue("@security_answer", user.SecurityAnswer);
                    sqlCommand.Parameters.AddWithValue("@client_IP", user.ClientIp);
        ...
        public long GetUserIdByUserDetails(Person userDetail)
        {
            ...
            using (var sqlConnection = new SqlConnection(mConnectionString))
            {
                using (var sqlCommand = sqlConnection.CreateCommand())
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@first_name ", userDetail.FirstName);
                    sqlCommand.Parameters.AddWithValue("@last_name", userDetail.LastName);
                    sqlCommand.Parameters.AddWithValue("@date_of_birth", userDetail.DateOfBirth);
                    sqlCommand.Parameters.AddWithValue("@social_security_number", userDetail.SSN);
        ...
        public bool UpdatePasswordResetCode(int resetCode, long userId)
        {
            ...
            using (var sqlConnection = new SqlConnection(mConnectionString))
            {
                using (var sqlCommand = sqlConnection.CreateCommand())
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@password_reset_code", resetCode);
                    sqlCommand.Parameters.AddWithValue("@user_id", userId);
